<?php $this->title = 'mNPS индекс | Оценка лояльности к руководителю'?>
            ...
            <div class="intro-container">
                <article class="intro-content">
                    <h1 class="intro-title -light">
                        <span class="-bold -middle">mNPS </span>
                        <span class="-small">индекс лояльности к руководителю</span>
                    </h1>
                    <div class="intro-buttons">
                        <a class="button-default feedback-form" data-button-text="Получить консультацию" data-fancybox="" data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','innerpages_event_click')">Получить консультацию</a>
                    </div>
                </article>
            </div>
            <img src="/img/happy-job/images/types-of-surveys/mnps-new.jpg" alt=">индекс лояльности к руководителю" class="intro-image">
        </section>
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <span itemprop="name">mNPS индекс</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        ...
                        <li>
                            <a href="#title_benchmark"> mNPS Бенчмарк </a>
                        </li>
                        <li>
                            <a href="#title1"> Как измеряется индекс mNPS сотрудников </a>
                        </li>
                        <li>
                            <a href="#title2"> Зачем измерять mNPS </a>
                        </li>
                        <li>
                            <a href="#title3"> Зачем сравнивать eNPS и mNPS </a>
                        </li>
                        <li>
                            <a href="#title4"> eNPS больше mNPS </a>
                        </li>
                        <li>
                            <a href="#title5"> eNPS меньше mNPS </a>
                        </li>
                        <li>
                            <a href="#title6"> Зачем
                                               исследовать лояльность к руководителю </a>
                        </li>
                        <li>
                            <a href="#title7"> Как корректировать mNPS </a>
                        </li>
                        <li>
                            <a href="#title8"> Как повысить
                                               лояльность руководителей среднего звена </a>
                        </li>
                        <li>
                            <a href="#title9"> Как активизировать желание
                                               рекомендовать руководителя </a>
                        </li>
                    </ul>
                </aside>
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                    ...
                    <h2 id="title0">Что такое mNPS</h2>
                    <p>
                        Известно, что руководители могут как компенсировать недостатки компании,
                        так и, наоборот, усиливать их.
                    </p>
                    <p>
                        Что ответят ваши сотрудники, если попросить их по отдельности
                        рекомендовать организацию и непосредственного руководителя?
                    </p>
                    <div class="row align-center">
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <img src="/img/happy-job/images/types-of-surveys/new/mnps-1.png" class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            <p>
                                <strong>mNPS</strong> — это метрика лояльности, которая показывает,
                                                      с какой вероятностью сотрудники будут рекомендовать работу со своими
                                                      непосредственными руководителями друзьям и родственникам.
                            </p>
                        </div>
                    </div>
                    <br>
                    <p>
                        Метрика измеряется путем вопроса
                        <b>«Готовы ли вы рекомендовать друзьям работать с вашим непосредственным
                           руководителем?»</b>. Респонденты оставляют оценки на шкале от 0 до 10, где 0 — нет, а 10 —
                        да. На основании оценки сотрудники делятся на три категории:
                        «Промоутеры», «Скептики» и «Критики».
                    </p>
                    <p>
                        <strong>
                    ...
                    <p>
                        Промоутеры готовы поддержать любые инициативы руководителя, открыты
                        новому опыту и качественной обратной связи, с энтузиазмом принимают
                        новые проекты и изменения, предложенные руководителем.
                    </p>
                    <p>
                        <strong>
                    ...
                    <p>
                        Скептики в целом довольны руководителем, но выполняют поставленные им
                        задачи без энтузиазма, не стремятся превосходить ожидания. Скептики
                        будут посильно участвовать в проектах, если руководитель убедит их в
                        целесообразности и полезности участия лично для них; они поддержат
                        изменения, если с подачи руководителя убедятся, что новшества
                        необходимы.
                    </p>
                    <p>
                        <strong>
                    ...
                    <p>
                        Критики недовольны руководителем: эта оценка может быть как объективной
                        («он не профессионал»), так и субъективной («он мне не нравится»). Как
                        правило, они открыто противостоят руководителю на планерках и
                        совещаниях, критикуют его за глаза, среди коллег и в близком кругу.
                        Недовольство руководителем может сказываться на качестве работы. Критики
                        не поддержат изменения, если инициатива будет исходить от руководителя.
                    </p>
                    <p>
                        Критики являются важным активом компании — они имеют смелость указывать
                        на реальную нехватку менеджерских качеств руководителя. С этой
                        категорией персонала важно установить контакт: узнать причину
                        разочарования и постараться улучшить ситуацию.
                    </p>
                    <h2 id="title1">Как измеряется индекс mNPS сотрудников</h2>
                    <p>Расчет mNPS довольно прост.</p>
                    <ol>
                        <li>
                            Проведите опрос сотрудников, в рамках которого задайте людям вопрос:
                            «Готовы ли вы рекомендовать друзьям работать с вашим непосредственным
                            руководителем?».
                        </li>
                        <li>
                        ...
                        <li>Результатом вычитания станет ваш mNPS сотрудников.</li>
                    </ol>
                    <p>
                        Допустим, опрос показал, что в подразделении компании 5 промоутеров, 4
                        скептика и 3 критика. Тогда доля промоутеров равна 42%, скептиков — 33%,
                        критиков — 25%, и mNPS составит: <br><b>42% − 25% = 17%.</b>
                    </p>
                    <p>
                        Еще раз подчеркнем: критиков не стоит воспринимать как врагов. Это не
                        «плохие» сотрудники, а такой же актив компании, часто — хорошие
                        профессионалы. Они не боятся высказывать «непопулярное» мнение, и
                        руководителям нужно работать, целенаправленно заслуживая их уважение,
                        повышая лояльность таких людей.
                    </p>
                    <p>
                        Согласно богатой исследовательской базе Happy Job, результаты выше +10
                        считаются хорошими. Если индекс ниже нуля или находится в диапазоне от 0
                        до +10, значит, в компании руководители являются, скорее, препятствиями
                        в эффективной работе, чем помощниками. Чем ниже значение, тем выше риск
                        потери ценных сотрудников, снижения качества продукции или услуг.
                    </p>
                    <p>
                        Процент рекомендующих компанию и руководителя может быть разным в одной
                        организации, то есть метрики eNPS и mNPS могут различаться. Измерение из
                        каждой метрик, их корректировка, сравнение между собой и устранение
                        перекосов между ними — важные задачи любой современной организации.
                    </p>
                    <style>
                        .comparecalc {
                            display: flex;
                            ...
                            <div class="comparecalc__form">
                                ...
                                <div class="comparecalc__form-content">
                                    <div class="comparecalc__form-col">
                                        <input class="comparecalc__form-number comparecalcnum" type="number" min="-100" max="100" placeholder="Ваш mNPS" id="compareCalcInputNum">
                                        <span></span>
                                    </div>
                                    <!--
        <div class="comparecalc__form-col">
          ...
          <span></span>
                        ...
                        <div class="comparecalc__calcblock">
                            <div class="comparecalc__calc" id="compareCalc" data-average="33">
                                <svg viewbox="0 0 100 100" style="display: block; width: 100%;">
                                    ...
                                    <path d="M 50,50 m 0,-47 a 47,47 0 1 1 0,94 a 47,47 0 1 1 0,-94" stroke-width="6" fill-opacity="0" id="compareCalcLine" style="stroke-dashoffset: 295.416;"></path>
                                </svg>
                            ...
                            <div class="comparecalc__result">
                                Ваш показатель на <b><span id="compareCalcResult"></span></b> <span id="compareCalcState"></span> среднего
                            </div>
                        </div>
                    </div>
                    <section class="compareForm">
                        ...
                        <form id="compare-index" class="c-form" data-parsley-validate>
                            <h2>Чтобы сравнить себя в отрасли, заполните форму, и мы пришлем вам результат на e-mail</h2>
                            ...
                            <ul class="c-form-list">
                                ...
                                <li class="c-form-item">
                                    ...
                                    <select id="industry" name="industry" required data-parsley-trigger="change" data-parsley-error-message="Укажите название отрасли">
                    ...
                    <h2 id="title2">Зачем измерять mNPS</h2>
                    <p>
                        Статистика, собранная в ходе многолетних исследований платформой Happy
                        Job, показывает: в 63% случаев увольнения главной причиной для
                        сотрудников становилось недовольство руководителем.
                    </p>
                    <br>
                    <section class="quote-banner wide-container">
                        <blockquote class="quote-banner-text animated fadeIn">
                            <div class="container">
                                <div class="row align-center">
                                    <div class="col-12">
                                        <p>Приходят люди в компанию, а уходят — от руководителя.</p>
                                    </div>
                                </div>
                            </div>
                        </blockquote>
                    ...
                    <p>
                        Словами и поступками менеджер может сильно воздействовать на поведение
                        подчиненных:
                    </p>
                    <ul>
                        <li>подавить инициативность,</li>
                        <li>потворствовать интригам и нездоровой конкуренции,</li>
                        <li>побудить к увольнению,</li>
                        <li>переманить вслед за собой в случае смены места работы.</li>
                    </ul>
                    <p>
                        mNPS — одна из недооцененных метрик лояльности персонала, доступная для
                        использования каждой организацией. В наше время она популярна у
                        большинства прогрессивных компаний, которые с ее помощью оценивают
                        доверие своих команд к бренду.
                    </p>
                    <p>
                        <b>
                            Платформа Happy Job — первая на российском рынке, на которой
                            существует возможность оценки mNPS: мы внедрили ее в сезоне 2020 года
                            и с тех пор получили большое количество положительных отзывов.
                        </b>
                    </p>
                    <h2 id="title3">Зачем сравнивать eNPS и mNPS</h2>
                    <p>
                        Причины, по которым сотрудники рекомендуют компанию и руководителя,
                        разные. Соответственно, возможны перекосы, когда персонал больше
                        привержен организации или, наоборот, своему непосредственному
                        руководителю.
                    </p>
                    <img src="/img/happy-job/images/types-of-surveys/new/mnps-2.png" alt="">
                    <br>
                    <p>
                        Сильный перекос в сторону eNPS или mNPS может стоить организации ценных
                        специалистов, а то и целых команд. Угрожающей можно считать следующую
                        разницу в показателях:
                    </p>
                    <ul>
                        <li>больше 1 балла в абсолютных величинах, например, 7.3 и 8.4;</li>
                        <li>больше 15-процентных пунктов в процентах, например, 61% и 78%;</li>
                        <li>
                            если рассматривать индексы, угрозу несет разница в 15 единиц и более
                            (например, +21.1 и +37.9).
                        </li>
                    </ul>
                    <p>
                        Рассмотрим возможные ситуации, при которых возникают перекосы в сторону
                        eNPS или mNPS.
                    </p>

                    <h2 id="title4">eNPS больше mNPS</h2>
                    <p>то есть лояльность к организации выше, чем к руководителю.</p>
                    <p>
                        <strong>Возможной причиной</strong> является то, что в организации
                                                            созданы условия для комфортной работы, но у линейного руководителя
                                                            слабые управленческие компетенции. Он:
                    </p>
                    <ul>
                        <li>непоследователен в действиях,</li>
                        <li>заводит любимчиков среди подчиненных,</li>
                        <li>использует в оценке двойные стандарты,</li>
                        <li>дает обратную связь низкого качества и т.д.</li>
                    </ul>
                    <p><strong>Как устранить перекос</strong></p>
                    <p>
                        Руководителю необходимо развивать свои лидерские и управленческие
                        качества. Кроме того, стоит провести дополнительное исследование:
                        добавить вопрос к сотрудникам о причинах низкой лояльности — или
                        запустить исследование вовлечённости, которое укажет на слабые места в
                        корпоративной культуре и рабочей среде.
                    </p>
                    <p>
                        Полезно будет нормализовать психологический климат в коллективе
                        следующими способами:
                    </p>
                    <ul>
                        <li>
                            установить правила, общие для всех, вне зависимости от стажа работы
                            сотрудника, его достижений и т.д.;
                        </li>
                        <li>
                            избегать приватных разговоров с отдельными приближенными сотрудниками,
                            отсылок к фактам, понятным лишь избранным;
                        </li>
                        <li>
                            выстроить в подразделении процесс регулярного предоставления обратной
                            связи в формате 1-on-1;
                        </li>
                        <li>
                            поддерживать мотивацию персонала частой и обоснованной похвалой.
                        </li>
                    </ul>
                    <h2 id="title5">eNPS меньше mNPS</h2>
                    <p>то есть лояльность к руководителю выше, чем к организации</p>
                    <p><strong>Возможные причины</strong> этого следующие:</p>
                    <ul>
                        <li>
                            В компании неудовлетворительные условия труда, отсутствуют перспективы
                            роста. От увольнения сотрудников удерживает преданность руководителю.
                        </li>
                        <li>
                            Словами и поступками руководитель снижает лояльность подчиненных к
                            компании: например, критикует высшее руководство, выставляя его
                            решения в негативном свете; не говорит подчиненным о целях и стратегии
                            организации; не информирует о важных проектах и событиях; говорит о
                            проводимых в организации изменениях в негативном ключе; не доносит до
                            сотрудников информацию об их карьерных перспективах.
                        </li>
                    </ul>
                    <p><strong>Как устранить перекос</strong></p>
                    <p>Руководителю необходимо выполнить перечисленные ниже действия.</p>
                    <ul>
                        <li>
                            Провести дополнительное исследование: добавить вопрос к сотрудникам о
                            причинах низкой лояльности — или запустить исследование вовлечённости,
                            которое укажет на слабые места в корпоративной культуре и рабочей
                            среде.
                        </li>
                        <li>
                            Организовать в компании системное обучение руководителей среднего
                            звена.
                        </li>
                        <li>
                            Передать HR-службе часть задач, влияющих на лояльность персонала:
                            например, информирование сотрудников об успехах организации, ценности
                            продукта для клиентов, стратегических целях компании,о внедряемых в
                    ...
                    <section class="its-simple -tablet" style="margin-bottom: -3rem">
                        <div class="its-simple-row">
                            ...
                            <div class="its-simple-content">
                                ...
                                <img src="/img/happy-job/images/devicebanner/text.svg" alt="просто!"><button type="button" class="button button-default button-modal" data-fancybox="" data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','sta_button')">
                    ...
                    <h2 id="title6">Зачем исследовать лояльность к руководителю</h2>
                    <p>
                        Любые преобразования в организации неизбежно встречают сопротивление
                        персонала: люди боятся, как бы новшества не ухудшили их текущее
                        положение и привычные процессы и условия. По этой причине лишь небольшая
                        часть инициатив в итоге доходит до реализации.
                    </p>
                    <p>
                        Компании, чтобы добиться массового принятия персоналом каких-либо
                        изменений, необходимо проводить большую разъяснительную работу,
                        рассказывать о задачах и результатах реформ, быть открытой к диалогу на
                        всех уровнях. Эту задачу на практике решают руководители на всех
                        уровнях: от генерального директора до непосредственного руководителя на
                        местах.
                    </p>
                    <p>
                        Если в конце коммуникационной цепочки лидер станет отмалчиваться или
                        высказываться против нововведений, сотрудники сочтут изменения опасными
                        для себя и примутся тормозить их внедрение. В глазах подчиненных
                        непосредственный начальник будет выглядеть честным человеком,
                        отстаивающим интересы команды, а компания — врагом.
                    </p>

                    <div class="row align-center">
                        <div class="col-sm-12 col-md-4 col-lg-4">
                            <img src="/img/happy-job/images/types-of-surveys/new/mnps-3.png" class="img-fluid" alt="">
                        </div>
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <br>
                            <p>
                                Парадоксальным образом высокий mNPS, который наряду с eNPS обычно
                                рассматривается как катализатор изменений и нововведений, залог их
                                принятия сотрудниками, — становится препятствием для развития
                                компании, если человек, которому доверяют, сам проявляет признаки
                                нелояльности или недостаточно профессионален, чтобы хорошо
                                справляться с менеджерскими функциями.
                            </p>
                        </div>
                    </div>
                    <br>
                    ...
                    <p>
                        Лояльность руководителю — ключевой фактор слаженной работы коллектива.
                        На практике это значит, что руководитель:
                    </p>
                    <ul>
                        <li>
                            выстраивает в подразделении продуктивную среду, то есть создает
                            комфортные условия работы, препятствует перегрузкам и выгоранию,
                            выступает фасилитатором процессов и коммуникаций, противостоит
                            интригам и нездоровой конкуренции;
                        </li>
                        <li>
                            занимается профессиональным развитием подчиненных, то есть обсуждает с
                            ними профессиональные треки и перспективы карьерного развития,
                            рекомендует обучающие курсы и программы, помогает применить полученные
                            на них навыки в работе;
                        </li>
                        <li>
                            проявляет искреннее участие к их жизни — как профессиональной, так и
                            личной.
                        </li>
                    </ul>
                    <p>
                        Но если сотрудники лояльны к руководителю, при этом нелояльны к компании
                        — организация сильно рискует имиджем на рынке труда и целостностью
                        коллектива.
                    </p>
                    <p>
                        Например, увольняясь, лидер может забрать команду с собой на новое
                        место.
                    </p>
                    <h2 id="title7">Как корректировать mNPS</h2>
                    <p>
                        Опираясь на результаты исследования вовлечённости и лояльности,
                        HR-служба может влиять на полученные цифры метрик mNPS, в том числе
                        заполнять пробелы в развитии персонала, появившиеся как следствие
                        нехватки менеджерских компетенций, незнания или намеренного саботажа
                        руководителей.
                    </p>
                    <p>
                        Так, для полноценного информирования сотрудников о возможностях
                        профессионального развития, на корпоративном портале размещается
                        страница с актуальными программами обучения, стажировками, открытыми
                        вакансиями, или по записи предоставляются карьерные консультации в
                        определенные дни.
                    </p>
                    <p>
                        Для ознакомления команды с нововведениями и изменениями в компании
                        HR-служба при поддержке PR-подразделения готовит статьи для
                        корпоративного портала, письма в рассылки, отвечает на возникающие
                        вопросы в специальных чатах.
                    </p>
                    <p>
                        <em>Однако HR-служба не в силах полностью заменить собой руководителя в
                            вопросах работы с персоналом и решения поставленных перед
                            подразделением бизнес-задач.</em>
                    </p>
                    <p>
                        Лидер может (и должен) давать каждому сотруднику персонализированную
                        регулярную обратную связь. HR-служба, при всем желании, не сможет дать
                        обратную связь такого же качества. В зависимости от масштаба компании на
                        одного HR-специалиста будут приходиться сотни сотрудников, значит,
                        обратная связь останется редкой и типизированной.
                    </p>
                    <p>
                        Вторая причина сложностей с корректировкой соотношения eNPS и mNPS лежит
                        в плоскости доверительных отношений, авторитета. Персонал больше
                        доверяет непосредственному руководителю, а не функциональным начальникам
                        или высшему руководству. Поэтому действия и слова руководителя будут
                        иметь больший эффект, нежели поступки и слова HR-специалиста.
                    </p>
                    <p>
                        Важно не отстранять руководителей от выполнения описанных выше функций,
                        а развивать в них лояльность к компании и обучать необходимым навыкам.
                    </p>
                    <p>
                        Лидеры так же, как и рядовые сотрудники, нуждаются в обратной связи,
                        похвале, осознании возможностей для профессионального и карьерного
                        роста. Полезными в решении этой проблемы являются опросы вовлечённости,
                        в которых руководители участвуют наряду со всеми сотрудниками компании.
                    </p>
                    <h2 id="title8">Как повысить лояльность руководителей среднего звена</h2>
                    <ul>
                        <li>
                            Запустить программы обучения для управляющего состава, на которых
                            руководители смогут развивать лидерские и управленческие компетенции.
                        </li>
                        <li>
                            Развивать наставничество на высшем уровне: опытные руководители должны
                            помогать менее опытным коллегам в вопросах управления персоналом —
                            подсказывать, как мотивировать команду, давать обратную связь,
                            расставлять приоритеты.
                        </li>
                        <li>
                            Планировать личные встречи руководителей с топ-менеджментом, особенно
                            на стадиях внедрения крупных изменений в компании. Это позволит
                            заручиться поддержкой руководителей среднего звена и добиться, чтобы
                            они заразили уверенностью свои команды.
                        </li>
                    </ul>
                    <br>
                    <br>
                        ...
                        <blockquote class="quote-banner-text animated fadeIn">
                            <div class="container">
                                <div class="row align-center">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-9 buzrum">
                                        <p style="padding-bottom: 0">
                                            «Каскадная мотивация- обязательное условие эффективной и
                                            успешной компании»
                                        </p>
                                        <p style="padding-top: 0; font-size: 14px">
                                            Алексей Клочков<br>(автор книги «Вовлечённость и лояльность
                                            от А до Я»)
                                        </p>
                                    </div>
                                </div>
                    ...
                    <br>
                    <h2 id="title9">Как активизировать желание рекомендовать руководителя</h2>
                    <p>
                        Если показатель mNPS проседает по сравнению с eNPS или вместе с ним, то
                        есть сотрудники не лояльны к руководителю, отговаривают друзей и
                        родственников от работы с ним, — необходимо укрепить доверие и авторитет
                        руководителя.
                    </p>
                    <p><b>Перечислим доступные способы:</b></p>
                    <ul>
                        <li>
                            наладить обратную связь лидера с каждым своим сотрудником: говорить о
                            текущих проектах, обсуждать профессиональное развитие и варианты
                            карьерного продвижения;
                        </li>
                        <li>
                            поощрять обратную связь «снизу-вверх»: максимально оперативно
                            реагировать на запросы сотрудников, особенно на критику, искать
                            способы решения проблем;
                        </li>
                        <li>
                            улучшать механизм взаимодействия подчиненных с руководителем, который
                            позволит им задать любые важные, по их мнению, вопросы;
                        </li>
                        <li>
                            регулярно проводить встречи «один на один», на которых руководитель
                            должен объяснять, из чего складывается заработная плата сотрудников и
                            почему она такая, какая есть;
                        </li>
                        <li>
                            сделать оплату труда, льготы и привилегии более привлекательными для
                            сотрудников, используя в качестве компенсации за профессиональные
                            достижения дополнительные дни отпуска, отгулы или возможность
                            несколько дней в неделю работать из дома;
                        </li>
                        <li>
                            позволить сотрудникам самостоятельно, по своему вкусу, обустраивать
                            рабочее место: приносить живые цветы, элементы декора и т. д. Условия
                            труда, включающие рабочее место и сам офис, оказывают большое влияние
                            на рекомендации сотрудников, поэтому руководителю полезно
                            прислушиваться к пожеланиям людей по вопросам комфортного рабочего
                            пространства.
                        </li>
                    </ul>
                </main>
...
<!-- endrender types-of-surveys/mnps//-->
