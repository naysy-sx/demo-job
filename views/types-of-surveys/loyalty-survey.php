<?php $this->title = 'Оценка лояльности сотрудников | Как измерить лояльность персонала компании'; ?>
<div class="container mainc">
    <main>
        ...
        <div class="top-baner wide-container" id="super-title-wrap">
            <img src="/img/happy-job/images/types-of-surveys/header_17_1.jpg">
            <div class="container">
                <div class="title wtext">
                    <h1>Исследование и оценка лояльности персонала</h1>
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <span itemprop="name">Исследование и оценка лояльности персонала</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        <li>
                            <a href="#title0"> Что такое лояльность </a>
                        </li>
                        <li>
                            <a href="#title_benchmark"> Лояльность Бенчмарк </a>
                        </li>
                        <li>
                            <a href="#title1"> Виды лояльности </a>
                        </li>
                        <li>
                            <a href="#title2"> Чем опасен низкий
                                               показатель </a>
                        </li>
                        <li>
                            <a href="#title3"> Какие факторы влияют <br>на лояльность </a>
                        </li>
                        <li>
                            <a href="#title4"> Анализ лояльности
                                               сотрудников </a>
                        </li>
                        <li>
                            <a href="#title5"> Группы лояльности </a>
                        </li>
                        <li>
                            <a href="#title6"> Как работать с каждой группой </a>
                        </li>
                        <li>
                            <a href="#title7"> Как
                                               повысить лояльность сотрудников </a>
                        </li>
                    </ul>
                </aside>
                <div class="loadarticle">
                    <div class="loadarticle__block">
                        ...
                        <div class="loadarticle__title">Исследование и оценка лояльности персонала</div>
                        <div class="loadarticle__cover" style="background-image:url('/img/happy-job/images/types-of-surveys/header_17_1.jpg')"></div>
                    </div>
                    <a href="/pdf/metodika-issledovaniya-loyalnosti-personala-happy-job.pdf" download class="loadarticle__button">Скачать статью в PDF</a>
                </div>
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                    ...
                    <h2 id="title0">Что такое лояльность</h2>
        ...
        <div class="comparecalc__form-col">
          ...
          <span></span>
                        ...
                        <div class="comparecalc__calcblock">
                            <div class="comparecalc__calc" id="compareCalc" data-average="78">
                    ...
                    <p>
                        ...
                        работает, связывает с ней будущее, как
                        правило, поддерживает изменения.
                    </p>
                    <div class="word_description">
                        <h3>Нормативная лояльность</h3>
                    ...
                    <h2 id="title2">Чем опасен низкий
                                    показатель</h2>
                    <p>
                    ...
                    <p style="margin-top: 45px">
                        <strong> 1. Потери от ухода ценных сотрудников </strong>
                    </p>
                    <p>
                    ...
                    <p style="margin-top: 45px">
                        <strong> 2. Высокие затраты на подбор персонала </strong>
                    </p>
                    <p>
                    ...
                    <p style="margin-top: 45px">
                        <strong> 3. Переплата ФОТ на 30% и более </strong>
                    </p>
                    <p>
                    ...
                    <p style="margin-top: 45px">
                        <strong> 4. Неэффективная трата инвестиционных денег </strong>
                    </p>
                    <p>
                    ...
                    <p style="margin-top: 45px">
                        <strong> 6. Потеря выручки </strong>
                    </p>
                    <p>
                    ...
                    <br>
                    <p>О рисках низкой лояльности смотрите в нашем видео.</p>
              ...
              <span class="videos-image-wrapper">
                  <picture>
                    ...
                    <h2 id="title3">Какие факторы влияют <br>на лояльность</h2>
                    <p>
                        У лояльности пять граней. Рассмотрим каждую грань и факторы, которые на
                        неё влияют.
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listflagicon"> </span>
                        <strong class="green"> Гордость за компанию </strong>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <strong> «Гордится компанией». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listflagicon"> </span>
                        <strong class="green">
                    ...
                    <p>
                        ...
                        <strong> «Остаётся в будущем». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listflagicon"> </span>
                        <strong class="green">
                    ...
                    <p>
                        На платформе Happy Job эта грань оценивается метрикой
                        <strong> «Рекомендует компанию». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listflagicon"> </span>
                        <strong class="green">
                    ...
                    <p>
                        На платформе Happy Job эта грань оценивается метрикой
                        <strong> «Остаётся сейчас». </strong>
                        Показатель в этой метрике является мощным триггером удержания персонала
                        в краткосрочной перспективе.
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listflagicon"> </span>
                        <strong class="green"> Стремление делать больше, чем требуется </strong>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <strong> «Стремится делать больше». </strong>
                    </p>
                    <h2 id="title4">Анализ лояльности
                                    сотрудников</h2>
                    <p>
                        ...
                        до 10. Средний балл по всем метрикам определяет сотрудника в одну из групп лояльности.
                    </p>

                    <p>Сумма % <b style="color: #ffc051;">слабо лояльных</b> (7-8.99 баллов) и <b style="color: #62bf3d;">лояльных</b> (9-10 баллов) составляет индекс лояльности компании/подразделения.</p>
                    <img alt="Лояльность сотрудников" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/types-of-surveys/metriki_loyalnosti_happy_Job_2.jpg" title="Метрики лояльности Happy Job">
                    <br>
                    <h3>Как получить точные данные во время опроса лояльности сотрудников</h3>
                    <p>
                    ...
                    <section class="its-simple -phone">
                        <div class="its-simple-row">
                            <figure class="its-simple-image">
                                <img src="/img/happy-job/images/devicebanner/2.png" alt="Лояльность персонала" title="Лояльность персонала в организации">
                            </figure>
                            <div class="its-simple-content">
                                <p>Измерить вовлечённость</p>
                                <img src="/img/happy-job/images/devicebanner/text.svg" alt="просто!">
                                <button type="button" class="button button-default button-modal" onclick="ym(46152993,'reachGoal','sta_button')" data-fancybox data-src="#main-modal" href="javascript:;">
                    ...
                    <h2 id="title5">Группы лояльности</h2>
                    <p>
                        Опрос лояльности персонала позволяет распределить сотрудников на три
                        группы — лояльных, слаболояльных и нелояльных.
                    </p>
                    <img alt="лояльность сотрудников к компании" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/Commitment.jpg" title="В зависимости от ответов сотрудники делятся на три группы лояльности">
                    <p style="margin: 30px 0 10px 0; color: #6bcc41">
                        <b> Лояльные сотрудники </b>
                    </p>
                    <p>
                    ...
                    <h2 id="title6">Как работать с каждой группой</h2>
                    <p>
                        <strong>
                    ...
                    <br>
                    <h3>Почему лояльность компании выше, чем руководителю</h3>
                    <p>
                    ...
                    <h3>Почему лояльность руководителю выше, чем компании</h3>
                    <p>
                    ...
                    <ol>
                        <li>
                            Руководитель выставляет высшее руководство и его решения в негативном
                            свете или сомневается публично в легитимности.
                        </li>
                        <li>
                            Руководитель не рассказывает о целях и стратегии компании или
                            транслирует их неправильно.
                        </li>
                        <li>
                            Руководитель не рассказывает о важности проводимых в организации
                            изменений или говорит в негативном ключе.
                        </li>
                        <li>
                            Руководитель не доносит информацию о карьерных перспективах и не
                    ...
                    <section class="its-simple -tablet" style="margin-bottom: 0">
                        <div class="its-simple-row">
                            <figure class="its-simple-image">
                                <img src="/img/happy-job/images/devicebanner/4.png" alt="платформа для опросов">
                            </figure>
                            <div class="its-simple-content">
                    ...
                    <h2 id="title7">Как
                                    повысить лояльность сотрудников</h2>
                    <p>
                    ...
                    <img alt="Меры для повышения лояльности сотрудников" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/types-of-surveys/Mery_dlya_povysheniya_loyalnosti.jpg" title="Меры для повышения лояльности сотрудников">
                    <br>
                    <p>
        ...
        <style media="screen">
            ...
            .listxicon {
                ...
                height: 24px;
                margin: -2px 10px 0 0;
                background: url(/img/happy-job/images/svg/x.svg) center no-repeat;
                background-size: contain;
            }
            .listflagicon {
                display: inline-block;
...
<!-- endrender types-of-surveys/loyalty-survey//-->
