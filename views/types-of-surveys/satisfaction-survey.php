<?php $this->title = 'Оценка удовлетворённости сотрудников работой — Опрос на Happy Job'; ?>
<div class="container mainc">
    <main>
        ...
        <div class="top-baner wide-container" id="super-title-wrap">
            <img src="/img/happy-job/images/types-of-surveys/header_18_0.jpg">
            <div class="container">
                <div class="title wtext">
                    <h1>Исследование удовлетво­рённости сотрудников</h1>
                    <div class="hero__button">
                <span class="contact button button--red button--bold" data-fancybox data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','innerpages_event_click')">
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <span itemprop="name">Исследование удовлетво­рённости сотрудников</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        <li>
                            <a href="#title0"> Что такое удовлетворённость </a>
                        </li>
                        <li>
                            <a href="#title_benchmark"> Удовлетворённость Бенчмарк </a>
                        </li>
                        <li>
                            <a href="#title1"> Чем грозит низкий показатель </a>
                        </li>
                        <li>
                            <a href="#title2"> Какие факторы влияют </a>
                        </li>
                        <li>
                            <a href="#title3"> Опрос на Happy Job </a>
                        </li>
                        <li>
                            <a href="#title4"> Группы удовлетворённости </a>
                        </li>
                        <li>
                            <a href="#title5"> Как
                                               часто следует проводить опросы удовлетворённости персонала </a>
                        </li>
                        <li>
                            <a href="#title6"> Как повысить
                                               удовлетворённость сотрудников </a>
                        </li>
                    </ul>
                </aside>
                <div class="loadarticle">
                    <div class="loadarticle__block">
                        ...
                        <div class="loadarticle__title">Исследование удовлетво­рённости сотрудников</div>
                        <div class="loadarticle__cover" style="background-image:url('/img/happy-job/images/types-of-surveys/header_18_0.jpg')"></div>
                    </div>
                    <a href="/pdf/metodika-issledovaniya-udovletvorennosti-personala-happy-job.pdf" download class="loadarticle__button">Скачать статью в PDF</a>
                </div>
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                    ...
                    <h2 id="title0">Что такое удовлетворённость</h2>
                    <div class="word_description">
                        <h3>Удовлетворённость</h3>
                        — отглагольное существительное, сформированное от глагола
                        «удовлетворить», то есть сделать кого-либо довольным, исполнить желание,
                        просьбу. У каждого человека есть базовые потребности, от компенсаций
                        которых зависит его удовлетворение трудом и компанией.
                    </div>
                    <div class="word_description">
                        <h3>Удовлетворение от труда</h3>
                        — показатель того, насколько человек доволен своей работой. К типовым
                        факторам, влияющим на комплексную удовлетворённость, относят условия
                        труда, оплату, комфорт и безопасность труда, а также содержание работы.
                    </div>
                    <p>
                        Удовлетворённость — одна из составляющих вовлечённости. Сотрудников
                        невозможно вовлечь в работу, если они недовольны уровнем оплаты труда,
                        условиями работы, содержанием работы и т.д. Эти факторы также называют
                        гигиеническими — они влияют на вовлечённость только при отрицательных
                        показателях. В свою очередь, при высокой удовлетворённости дальнейшее
                        улучшение только этих факторов не приводит к заметному росту вовлечения
                        в работу.
                    </p>
                    <style>
                        .comparecalc {
                    ...
                    <div class="comparecalc" id="title_benchmark">
                        <div class="comparecalc__info">
                            <div class="comparecalc__title">
                                <h2>Удовлетворённость Бенчмарк</h2>
                            </div>
                            ...
                            <div class="comparecalc__form">
                                <div class="comparecalc__form-title">
                                    Сравните Ваш индекс удовлетворённости с показателем по России
                                </div>
                                <div class="comparecalc__form-content">
                                    <div class="comparecalc__form-col">
                                        <input class="comparecalc__form-number comparecalcnum" type="number" min="-100" max="100" placeholder="Ваш индекс" id="compareCalcInputNum">
                                        <span></span>
                                    </div>
                                    <!--
        <div class="comparecalc__form-col">
          ...
          <span></span>
                        ...
                        <div class="comparecalc__calcblock">
                            <div class="comparecalc__calc" id="compareCalc" data-average="80">
                    ...
                    </script>      <h2 id="title1">Чем грозит низкий показатель</h2>
                    <p>
                        Низкая удовлетворённость персонала приводит к низкой вовлечённости.
                        Таким образом, компания может столкнуться со следующими проблемами:
                    </p>
                    <ol class="red">
                        <li>
                            <b> Потеря клиентов и снижение выручки. </b>
                            Сотрудники будут проявлять равнодушие по отношению к потребностям
                            клиентов, не станут вникать в особенности продукта, его отличия от
                            продуктов конкурентов. В результате подразделения с низкой
                            удовлетворённостью теряют на 26% больше клиентов, по сравнению с
                            подразделениями с удовлетворённым персоналом — следует из заказного
                            исследования Happy Job.
                        </li>
                        <li>
                            <b> Увеличение производственных потерь. </b>
                            Также по статистике сотрудники в этом случае на 41% чаще допускают
                            ошибки в работе и на 48% чаще становятся жертвами несчастных случаев
                            на производстве.
                        </li>
                    </ol>
                    <br>
                    <p>
                        Помимо прямых финансовых рисков, есть негативные эффекты, с трудом
                        поддающиеся оценке, но влияющие на деятельность и результаты компании:
                    </p>
                    <ol class="red">
                        <li>
                            <b> Тотальный контроль. </b>
                            Руководитель вынужден заниматься надзором за неудовлетворёнными
                            подчинёнными, так как они склонны допускать ошибки в работе. Контроль
                            отнимает время, которое руководитель мог бы потратить на развитие
                            команды, принятие важных управленческих решений и т.д.
                        </li>
                        <li>
                            <b> Отсутствие доверия. </b>
                            Много времени сотрудники занимаются выяснением отношений вместо
                            работы. В результате качество командной работы снижается.
                        </li>
                        <li>
                            <b> Бюрократия. </b>
                            В подразделении никто не занимается совершенствованием процессов. Как
                            следствие — неотлаженные процессы и чрезмерно сложная система
                            отчётности.
                        </li>
                    </ol>
                    <h2 id="title2">Какие факторы влияют</h2>
                    <p>
                        Наиболее сильно на удовлетворённость сотрудников влияют пять факторов.
                        Рассмотрим их.
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listhandicon"> </span>
                        <strong class="green"> Оплата труда </strong>
                    </p>
                    <p>
                        Размер оплаты — один из главных мотиваторов к труду. Если человек
                        посчитает, что ему платят недостаточно за работу, его производительность
                        упадёт или он будет искать новое место работы.
                    </p>
                    <p>
                        На платформе Happy Job этот фактор оценивается через метрику
                        <strong> «Оплата». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listhandicon"> </span>
                        <strong class="green"> Условия труда </strong>
                    </p>
                    <p>
                        На удовлетворённость персонала большое влияние оказывают физические
                        параметры рабочего окружения. Например, температура и уровень шума в
                        офисе. Жара, холод или зашумлённость ведут к снижению концентрации
                        внимания и, как следствие, к частому появлению ошибок в работе.
                    </p>
                    <p>
                        На платформе Happy Job этот фактор рассматривается в метрике
                        <strong> «Условия труда». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listhandicon"> </span>
                        <strong class="green"> Содержание труда </strong>
                    </p>
                    <p>
                        Когда сотрудникам интересно наполнение их работы, они получают
                        удовольствие от её выполнения. Интерес к работе напрямую влияет на
                        уровень вовлечённости и удовлетворённости.
                    </p>
                    <p>
                        Исследование Happy Job показало, что интерес к выполняемым задачам может
                        обеспечить использование разнообразных навыков и опыта.
                    </p>
                    <p>
                        Этот фактор удовлетворённости оценивается метрикой
                        <strong> «Интерес». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listhandicon"> </span>
                        <strong class="green"> Безопасность труда </strong>
                    </p>
                    <p>
                        Пренебрежение безопасностью персонала на рабочем месте приведёт к
                        снижению продуктивности. Людям важно чувствовать, что об их здоровье
                        беспокоятся.
                    </p>
                    <p>
                        На платформе Happy Job этот фактор оценивается метрикой
                        <strong> «Безопасность». </strong>
                    </p>
                    <p style="margin-top: 45px">
                        <span class="listhandicon"> </span>
                        <strong class="green"> Комфорт труда </strong>
                    </p>
                    <p>
                        На удовлетворённость сотрудников оказывает влияние сам офис, рабочее
                        место, используемые средства труда. Они способны повышать моральный дух
                        и увеличивать продуктивность.
                    </p>
                    <p>
                        Насколько комфортно персоналу трудиться, можно выяснить через метрику
                        Happy Job
                        <strong> «Комфорт труда». </strong>
                    </p>
                    <br>
                    <br>
                    ...
                    <h2 id="title3">Опрос на Happy Job</h2>
                    <p>
                        На платформе Happy Job оценка удовлетворённости персонала производится
                        по пяти метрикам — «Оплата», «Условия труда», «Интерес», «Безопасность»,
                        «Комфорт труда», которые являются субметриками
                        <a href="/types-of-surveys/engagement-survey/"> метрик вовлечённости </a>
                        «Условия и оплата» и «Процессы».
                    </p>
                    <p>
                        Каждой метрике соответствует свой вопрос, ответы по которому формируют
                        балл от 1 до 10. Среднее арифметическое по всем пяти метрикам является
                        показателем удовлетворённости персонала.
                    </p>
                    <br>
                    <img alt="Удовлетворенность работой" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/types-of-surveys/Faktory_udovletvorennosti.jpg" title="На удовлетворённость сотрудников влияет пять факторов">
                    <br>
                    <h3>Почему опросы удовлетворённости должны быть анонимными</h3>
                    <p>
                        Получить достоверные результаты исследования можно только одним способом
                        — обеспечив людям 100%-ную анонимность участия в опросе.
                    </p>
                    <p>
                        99,9% сотрудников боятся, что их честные комментарии и ответы негативно
                        скажутся на отношениях с руководителем и коллегами. Побороть страх перед
                        опросом можно только организацией безопасного пространства для сбора
                        обратной связи, через гарантию видимости результатов по подразделению от
                        пяти человек и выше.
                    </p>

                    <section class="its-simple -tablet" style="margin-bottom: 0">
                        <div class="its-simple-row">
                            <figure class="its-simple-image">
                                <img src="/img/happy-job/images/devicebanner/4.png" alt="Удовлетворенность трудом">
                            </figure>
                            <div class="its-simple-content">
                                ...
                                <button type="button" class="button button-default button-modal" data-fancybox data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','sta_button')">
                                    Расскажите мне больше
                                </button>
                            </div>
                        </div>
                    </section>
                    <h2 id="title4">Группы удовлетворённости</h2>
                    <p>
                        Сотрудников в зависимости от их ответов можно поделить на три группы по
                        силе удовлетворённости: высокую, среднюю и низкую.
                    </p>
                    <img alt="Удовлетворенность персонала" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/types-of-surveys/Gruppy_udovletvorennosti.jpg" title="По степени удовлетворённости условиями труда и оплатой сотрудники делятся на три группы">
                    <p style="margin: 30px 0 10px 0; color: #6bcc41">
                        <b> Высокая </b>
                    </p>
                    <p>
                        В эту группу попадают люди со средним балом по метрикам
                        удовлетворённости 9 и более. Они, как правило, довольны условиями труда,
                        уровнем оплаты. При наличии в компании продуктивной рабочей среды,
                        покажут высокую вовлечённость в работу.
                    </p>
                    <p style="margin: 30px 0 10px 0; color: #e5c91d">
                        <b> Средняя </b>
                    </p>
                    <p>
                        В этой группе оказываются сотрудники со средним баллом 7 и выше, но
                        меньше 9. В целом они довольны организованными для работы условиями, но
                        могут активно рассматривать другое место работы.
                    </p>
                    <p style="margin: 30px 0 10px 0; color: #ef4244">
                        <b> Низкая </b>
                    </p>
                    <p>
                        Эта группа состоит из персонала со средним баллом ниже 7. Сотрудники из
                        этой группы недовольны условиями труда, уровнем оплаты, наполнением
                        работы. Даже при наличии продуктивной рабочей среды они будут показывать
                        низкую вовлечённость.
                    </p>
                    <section class="its-simple -phone">
                        <div class="its-simple-row">
                            <figure class="its-simple-image">
                                <img src="/img/happy-job/images/devicebanner/1.png" alt="Удовлетворенность сотрудников">
                            </figure>
                            <div class="its-simple-content">
                                <p>Измерить вовлечённость</p>
                                <img src="/img/happy-job/images/devicebanner/text.svg" alt="просто!">
                                <button type="button" class="button button-default button-modal" data-fancybox data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','sta_button')">
                                    Расскажите мне больше
                                </button>
                    ...
                    <h2 id="title5">Как
                                    часто следует проводить опросы удовлетворённости персонала</h2>
                    <p>
                        Периодичность опросов удовлетворённости персонала зависит от численности
                        компании, а также задач, которые стоят перед исследованием.
                    </p>
                    <p>Существует несколько форматов исследования:</p>
                    <ul style="margin-left: 20px">
                        <li style="margin-top: 30px">
                            •
                            <strong> Ежегодный опрос. </strong>
                            Этот формат предполагает проведение исследования из 5 вопросов. 5
                            вопросов на удовлетворённость дадут верхний срез количественных
                            показателей, поэтому для построения причинно-следственных связей
                            рекомендуется использовать большое исследование вовлечённости.
                        </li>
                        <li style="margin-top: 30px">
                            •
                            <strong> Пульс-опрос. </strong>
                            После проведения основного опроса выявляются проблемные метрики. Они
                            становятся базой для формирования анкеты пульсовых замеров между
                            большими исследованиями. Формат даёт возможность отслеживать
                            настроения персонала и своевременно принимать меры. Использование
                            пульс-опросов позволяет получить отличные результаты уже к следующему
                            большому исследованию. Этот формат рекомендуется как самый эффективный
                            с точки зрения внедрения изменений. Он даёт постоянный канал обратной
                            связи и возможность непрерывного развития.
                        </li>
                    </ul>
                    <h2 id="title6">Как повысить
                                    удовлетворённость сотрудников</h2>
                    <p>
                        На платформе Happy Job предусмотрены рекомендации по улучшению
                        результатов опроса удовлетворённости персонала трудом.
                    </p>
                    <p>Рассмотрим в качестве примера метрику «Интерес».</p>
                    <br>
                    <img alt="Меры для повышения удовлетворённости сотрудников" data-entity-type="" data-entity-uuid="" src="/img/happy-job/images/types-of-surveys/Mery_dlya_povysheniya_udovletvorennosti.jpg" title="Меры для повышения удовлетворённости сотрудников">
                    <br>
                    <br>
                    <p>
                        Для улучшения показателей метрики на платформе даются типовые меры,
                        которые можно добавить в план работ. Таким образом, руководитель будет
                        видеть, какие действия он избрал для улучшения показателя, что уже
                        сделал, а что ещё нет.
                    </p>
                    <p>
                        Реализовав меры, предложенные платформой Happy Job, можно значительно
                        повысить показатель удовлетворённости персонала за отчётный период.
                    </p>
                    <style media="screen">
                        .loadarticle__title {
                            font-size: 20px;
        ...
        <style media="screen">
            .listhandicon {
                ...
                height: 24px;
                margin: -6px 10px 0 0;
                background: url(/img/happy-job/images/dropdown/hand_h.svg) center no-repeat;
                background-size: contain;
            }
...
<!-- endrender types-of-surveys/satisfaction-survey//-->
