<?php $this->title = 'Форматы исследований вовлечённости персонала | Happy Job'; ?>
...
<div class="container mainc">
    <main>
        ...
        <div class="top-baner wide-container" id="super-title-wrap">
            <img src="/img/happy-job/images/surveyformats/shapka_format.jpg">
            <div class="container">
                <div class="title wtext">
                    <h1>Форматы исследований</h1>
                    <div class="formats-navigation">
                        <a href="#title0" class="button-outline -light"><b class="icon-arrow"></b>Ежегодный опрос</a>
                        <a href="#title1" class="button-outline -light"><b class="icon-arrow"></b>Пульс-опрос</a>
                        <a href="#title2" class="button-outline -light"><b class="icon-arrow"></b>Глубинный пульс</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <span itemprop="name">
          Главная</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                ...
                                <span itemprop="name">Форматы исследований</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        <li>
                            <a href="#title0"> Ежегодный опрос </a>
                        </li>
                        <li>
                            <a href="#title1"> Пульс-опрос </a>
                        </li>
                        <li>
                            <a href="#title2"> Глубинный пульс </a>
                        </li>
                    </ul>
                </aside>
        ...
        <span itemprop="name">
          Главная</span>
                    ...
                    <h2 id="title0" class="h2-with-icon">
                        <span class="format-icon format-icon_1"> </span>
                        Ежегодный опрос
                    </h2>
                    <p>Наиболее широко используется организациями в любой отрасли.</p>
                    <p>
                        Полугодовой опрос вовлечённости — это надежный способ получить более
                        глубокое представление о поведении, настроении сотрудников, риска
                        увольнений и их отношении к организации.
                    </p>
                    <p>
                        Опрос состоит из 59 вопросов для офисных сотрудников и 31 вопроса для
                        вне офисных, касающихся того, как сотрудник относится к различным
                        аспектам работы.
                    </p>
                    <p>
                        Исследования в таком крупном формате проводятся минимум 1 или 2 раза в
                        год (по нашей статистике, 9 из 10 компаний всё-таки предпочитают
                        проводить оценку 2 раза в год - каждые 6 месяцев.)
                    </p>
                    <p>
                        На платформе Happy Job ежегодное исследование, включает вопросы по
                        вовлечённости, лояльности и удовлетворенности которые разом задаются
                        всем сотрудникам.
                    </p>
                    <p>
                        Ежегодный опрос проводится в течение от 1 до 3 недель, в зависимости от
                        количества респондентов (сотрудников) и локации подразделений компании.
                        Компания с помощью такого исследования получает периодический канал
                        обратной связи и возможность для развития продуктивности и сохранить
                        лучших сотрудников.
                    </p>
                    <div class="formaticons">
                        <div class="formaticons__item">
                            <div class="formaticons__img">
                                <img src="/img/p/survey-formats/1.png" alt="Вопросы исследования">
                            </div>
                            <div class="formaticons__text">
                                Все вопросы исследования <br>в единой анкете
                            </div>
                        </div>
                        <div class="formaticons__item">
                            <div class="formaticons__img">
                                <img src="/img/p/survey-formats/2.png" alt="Календарь исследований">
                            </div>
                            <div class="formaticons__text">
                                1-2 раза в год. <br>Исследование длится <br>от 1 до 3 недель
                            </div>
                        </div>
                        <div class="formaticons__item">
                            <div class="formaticons__img">
                                <img src="/img/p/survey-formats/3.png" alt="Время прохождения опроса">
                            </div>
                            <div class="formaticons__text">
                                Время прохождения <br>опроса: 5-10 минут
                            </div>
                        </div>
                    </div>
                    <div class="description">
                        <p>
                            <b style="display: inline-block"> Ежегодный формат </b>
                            — это наиболее востребованный HR опрос, так как это фундаментальный и
                            необходимый опрос. Это помогает в сборе большого количества данных,
                            касающихся взглядов сотрудников на различные изменения в организации,
                            которые происходят в течение года, позволяет понять причины текучести
                            или удержания сотрудников, помогает определить эмоциональную
                            приверженность сотрудников организации и уровень удовлетворенности
                            работой. Он также оценивает реакцию сотрудников на различные политики
                            компании и много др.
                        </p>
                    </div>
                    <br>
                    <br>
                    <p>
                        При таком большом количестве изменений, происходящих в течение года,
                        один раз проведенный опрос предоставит неадекватные и ненадежные данные.
                        Например, вовлеченный и счастливый сотрудник в августе может не
                        чувствовать себя так же к концу года. Это приведет к получению
                        недостоверных и общих данных.
                    </p>
                    <p>
                        Чтобы учесть все эти изменения, необходимо обеспечить регулярность и
                        детальность опросов.
                    </p>

                    <section>
                        <h2 id="title1" class="h2-with-icon">
                            <span class="format-icon format-icon_2"> </span>
                            Пульс-опрос
                        </h2>
                        <p>
                            Данным форматом называется исследование более короткое по своему
                            объёму (т.е. меньший набор вопросов), но более частое, чем ежегодный
                            опрос.
                        </p>
                        <p>
                            Как следует из термина «пульс», опрос проводится для того, чтобы
                            постоянно отслеживать мнение сотрудников до получения следующих итогов
                            большого исследования и оценивать эффективность принятых мер по
                            развитию.
                        </p>
                        <p>
                            Пульс-опросы, как правило, больше фокусируются на конкретной
                            проблемной метрике или наборе связанных метрик, тогда как ежегодные
                            опросы вовлечённости и лояльности сотрудников охватывают более широкий
                            круг факторов. Поскольку «пульсы» проводятся чаще, HR или менеджер
                            подразделения может оценить, как определенные метрики реагируют на
                            изменения в целом.
                        </p>
                        <div class="formaticons">
                            <div class="formaticons__item">
                                ...
                                <div class="formaticons__text">
                                    Меньше количество <br>вопросов, более частые <br>опросы
                                </div>
                            </div>
                            <div class="formaticons__item">
                                <div class="formaticons__img">
                        ...
                        <h4>
                            <strong> Пульс-опрос используют в 2 вариантах: </strong>
                        </h4>
                        <ul class="section-list">
                            <li>
                                В рамках ежегодного исследования платформа автоматически определяет
                                приоритетные метрики для развития, отсюда название «авто» пульс
                                опрос. Современные цифровые технологии позволяют точечно работать с
                                вовлечённостью и лояльностью в каждом подразделении, т.е. по каждому
                                подразделению формируется перечень проблемных метрик и пульс-опрос,
                                который будет предложен к запуску HR сотруднику организации или
                                руководителю подразделения.
                            </li>
                            <li>
                                Второй вариант применения пульс-опроса менее точен по воздействию,
                                но более централизован, т. к. используется единая отправка общего
                                пульс-опроса по типовым проблемам всех подразделений. Алгоритм
                                определения проблемных метрик схож с первым вариантом.
                            </li>
                        </ul>
                        <p>
                            Самое популярное использование пульс-опросов осуществляется между
                            большими (полугодовыми и годовыми) исследованиями несколько раз в
                            году.
                        </p>
                        <p>
                            Созданный алгоритмом пульсовой опрос по проблемным метрикам мы
                            рекомендуем проводить не раньше, чем через 1,5–2 месяца после
                            ежегодного исследования. В пульс-опросе, как правило, от 5 вопросов и
                            следующий возможен через 2 месяца после предыдущего. Таким образом
                            компания получает постоянный, но не слишком частый канал обратной
                            связи. Платформа Happy Job рекомендует всем клиентам данный формат
                            исследований как самый эффективный с точки зрения своевременной
                            реакции на проблемы и поддержки изменений.
                        </p>
                        <p>
                            Еще одна причина, по которой опросы в режиме пульса очень эффективны,
                            заключается в том, что они заставляют сотрудников чувствовать внимание
                            компании к их предложениям и мнениям, т. к. полгода и год очень
                            большой срок ожидания изменений и это снижает мотивацию у большинства
                            участников исследований, если им не дали обратной связи и не спросили
                            про проблемные метрики дополнительно. После того, как вы предприняли
                            какое-либо действие, проведите опрос, чтобы измерить его успех.
                            Сохраните то, что работает, и попробуйте другие способы решения
                            оставшихся проблем.
                        </p>
                    </section>
                    <br>
                        ...
                        <div class="container">
                            <div class="grid">
                                <div class="offer-col offer-col-1">
                                    <img class="offer-image" src="/img/happy-job/images/bag.png" loading="lazy" alt="">
                                </div>
                                <div class="offer-col offer-col-2">
                                    <p class="offer-text">
                                        Мы подготовим детальное КП <strong>прямо сейчас</strong>
                                    </p>
                                    <img src="/img/happy-job/images/devicebanner/text2.svg" loading="lazy" alt="">
                                </div>
                                <div class="offer-col offer-col-3">
                                    <a class="button-default" data-button-text="Получить лучшую цену" data-fancybox data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','kp_click')">Получить лучшую цену</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    <br>
                    <a id="deeppulse" style="position: relative; top: -90px"> </a>
                    <section>
                        <h2 id="title2" class="h2-with-icon">
                            <span class="format-icon format-icon_3"> </span>
                            Глубинный пульс
                        </h2>
                        <p>
                            Глубинный пульс это исследование с детальной аналитикой по метрике/
                            субметрике вовлечённости или лояльности.
                        </p>
                        <p>
                            Исследование включает в себя от 5 дополнительных раскрывающих
                            вопросов, цель которых – собрать максимально объективную информацию и
                            разобраться в причинах проблем для принятия управленческих решений.
                            Детальное исследование проводится по методике Happy Job или по
                            вопросам Заказчика и является хорошей альтернативой фокус группам,
                            т.к. практически не отвлекает сотрудников.
                        </p>
                        <div class="formaticons">
                            <div class="formaticons__item">
                                <div class="formaticons__img">
                                    <img src="/img/p/survey-formats/4.png" alt="Вопросы исследования">
                                </div>
                                <div class="formaticons__text">
                        ...
                        <h4>
                            <strong> Глубинный пульс используется в 2 вариантах: </strong>
                        </h4>
                        <ol class="section-numlist">
                            <li>
                                В рамках
                                <u> ежегодного опроса </u>
                                , при негативном ответе респондентов на вопрос, алгоритм платформы
                                сразу предлагает оценить 5–10 дополнительных факторов на одной
                                карточке, раскрывающих причины негативного ответа. Например, такой
                                опрос может содержать 5–6 факторов стресса, переработок или проблем
                                с безопасностью труда.
                            </li>
                            <li>
                                Второй вариант применения использования более свободный, вы просто
                                выбираете готовый шаблон исследований платформы «глубинного опроса»
                                и запускаете в любое удобное время до основного ежегодного
                                исследования.
                            </li>
                        </ol>
                        <p>
                            Теперь давайте поговорим о том, почему компании предпочитают ту или
                            иную частоту опросов. Наиболее популярными в бизнесе по частоте
                            использования стали ежегодные - полугодовые опросы. Это во многом
                            объясняется установившимися традициями: большинство HR-исследований в
                            силу масштабности и сложности реализации трудно проводить чаще, чем
                            два раза в год. Исследование лояльности и вовлечённости,
                            соответственно, тоже относятся к сложным исследованиям.
                        </p>
                        <p>
                            Ежегодные и полугодовые опросы позволяют изучить динамику изменения
                            настроений в компании за большой период, увидеть картину развития
                            корпоративной культуры и вовлечённости команд. В остальном специфика
                            проведения такого исследования — объёмные опросники, фокусировка на
                            общих вопросах, не позволяет объективно отслеживать реакцию
                            сотрудников на конкретные меры руководства или события. Отвечая на
                            вопросы, респонденты, как правило, вспоминают опыт последних месяцев,
                            игнорируя собственные ощущения полугодовой и более давности. Поэтому
                            рекомендуется дополнять такие ежегодные опросы, например,
                            пульс-опросами и глубинными опросами, чтобы следить за проблемными
                            метриками - быстрее и точнее реагировать на проблемы.
                        </p>
                        <p>
                            <i>
                                Важно дать сотрудникам общий обзор ваших выводов из любого опроса.
                                Во-первых, это дает больше уверенности в том, ясно ли дошло их
                                сообщение до вас.
                            </i>
                        </p>
                        <p>
                            <i>
                                Это также поможет вам установить отправную точку для вашего ответа,
                                которая поможет сотрудникам понять, что вы собираетесь исправить в
                                первую очередь.
                            </i>
                        </p>
                        <p>
                            Ежегодное исследование не может быть заменено пульсовым или глубинным
                            опросом, но они определенно могут дополнить ежегодное исследование и
                            сделать ваши меры по развитию вовлечённости более точными и быстрыми.
                        </p>
                        <p>
                            Поэтому комплексное ежегодное исследование для получения полной
                            картины, смешанное с короткими и быстрыми форматами, было бы идеальным
                            для роста любой организации.
                        </p>
                    </section>
                    <br>
                    <br>
                    ...
                    <style media="screen">
                        ...
                        .offer-image {
                            ...
                            left: clamp(
                                    0rem,
                                    -1.3214285714285714rem + 6.607142857142858vw,
                                    4.625rem
                            );
                            max-height: 240px;
                        }
                        ...
                        .formats-navigation .icon-arrow {
                            margin-right: 14px;
                        }

                        .formats-navigation .button-outline.-light,
                        .formats-navigation .button-outline.-light:active {
                        ...
                        .video-section .footerreviews__col {
                            width: auto;
                        }

                        .video-section .footerreviews__logo img {
                            margin: 0 auto 0 0;
                        }
                        ...
                        .format-icon_1 {
                            background-image: url(/img/happy-job/images/format_icon_1.png);
                        }

                        .format-icon_2 {
                            background-image: url(/img/happy-job/images/format_icon_2.png);
                        }

                        .format-icon_3 {
                            background-image: url(/img/happy-job/images/format_icon_3.png);
                        }
                    </style>
                </main>
            </div>
        ...
        <script>
            $(function () {
                $(document).on(
                    "click",
                    ".formats-navigation .button-outline",
                    function (event) {
