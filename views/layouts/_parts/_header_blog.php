...
<style>
    ...
    .site-header-wrapper.-blog .site-header {
        display: grid;
        grid-template-columns: 240px auto 1rem auto 1rem 256px 256px 190px;
        grid-template-rows: auto auto;
        grid-column-gap: 10px;
    ...
    .site-header-wrapper.-blog .site-header-logo{
        grid-column: 1 / 2;
        grid-row: 1 / 2;
    }

    .site-header-wrapper.-blog .site-header-nav {
        grid-column: 2 / 5;
        grid-row: 1 / 2;
    }
    .site-header-wrapper.-blog .site-header-home,
    .site-header-wrapper.-blog .site-header-line{
        display: none;
    }
    ...
    @media (max-width: 1200px) {
        ...
        .site-header-wrapper.-blog .site-header {
            grid-template-columns: 180px 1fr auto 140px 37px;
            grid-template-rows: auto auto;
        }
        ...
        .site-header-wrapper.-blog .navigation-list {
            margin: 0;
            justify-content: flex-start;
        }

        .site-header-wrapper.-blog .mobile-menu-button{
            display: none;
        }
        .site-header-wrapper.-blog .subnavigation-heading,
        .site-header-wrapper.-blog .extranavigation-heading {
            display: none;
        }
    ...
    @media (min-width: 577px) {
        ...
        .site-header-wrapper.-blog .site-header-contacts {
    ...
    @media (max-width: 577px) {
        ...
        .site-header-wrapper.-blog .site-header {
            grid-template-columns: 180px auto 37px 37px;
            grid-template-rows: auto auto;
        }
        .site-header-wrapper .site-header-button {
            grid-column: 3 / 4;
        ...
        .site-header-wrapper.-blog.mobile-menu-visible .site-header-nav {
            display: block;
            grid-column: 1 / 5;
            grid-row: 2 / 3;
        }
...
<header class="site-header-wrapper -blog topbannerID">
