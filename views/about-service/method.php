<?php $this->title = 'Платформа Happy Job | Процессы по оценке и развитию вовлечённости | Happy Job'; ?>
<div class="container mainc">
    <main>
        ...
        <span class="-middle">Digital-процессы оценки и развития вовлечённости, лояльности и
          eNPS</span>
                    </h1>
            ...
            <img src="/img/happy-job/images/about_service.jpg" alt=">Digital-процессы оценки и развития вовлечённости"
                 class="intro-image">
        </section>
        ...
        <div class="clients-page method-page">
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  О сервисе</span>
                        ...
                        <li class="breadcrumbs-item" itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                            <span itemprop="name">Digital-процессы оценки и развития вовлечённости, лояльности и eNPS</span>
            ...
            <span id="profit-for-clients"> Польза от использования Happy Job </span>
            <div class="profit">
                <div class="profit__wrapper">
                    <div class="profit__item profit__item-1">
                        <img src="/img/happy-job/images/clients/cl-1.svg" alt="Рост бизнеса" class="profit__img"
                             title="Продуктивность сотрудников напрямую влияет на финансовые показатели компании">
                        <div class="profit__label">Рост бизнеса</div>
                    </div>
                    <div class="profit__item profit__item-2">
                        <img src="/img/happy-job/images/clients/cl-2.svg" alt="Реализация изменений" class="profit__img"
                             title="Сотрудники могут увидеть реальные изменения в компании на основе своих идей и предложений.">
                        <div class="profit__label">Реализация изменений</div>
                    </div>
                    <div class="profit__item profit__item-3">
                        <img src="/img/happy-job/images/clients/cl-3.svg" alt="Снижение текучести" class="profit__img"
                             title="Создание продуктивной рабочей среды помогает снизить уровень текучести и удерживать ценных сотрудников">
                        <div class="profit__label">Снижение текучести</div>
                    </div>
                </div>
                <p>
                    Регулярное участие в 100% анонимном опросе с понятным обоснованием целей
                    сводит к минимуму недоверие, превращая исследование в увлекательный
                    процесс.
                </p>
                <p>
                    Платформа предоставляет каждому возможность участия в развитии и жизни
                    своей организации. Сотрудники могут увидеть реальные изменения в компании
                    на основе своих идей и предложений.
                </p>
            </div>
        </div>
        ...
        <br>
        <p>
            На платформе Happy Job процессы реализованы с учётом
            <a target="_blank" href="/hr-blog/hr-zero-chto-eto-za-princip-i-dlya-chego-nuzhen/">
                принципа HR Zero
            </a>
            : HR-специалисты внедряют изменения руками руководителей. Подход, при котором
            руководитель сам реализует инициативы по повышению продуктивности рабочей
            среды, даёт высокие результаты — в первый же год, по нашим данным,
            вовлечённость сотрудников может вырасти до 82%.
        </p>
        <p>
            Развитие вовлечённости и лояльности на платформе Happy Job происходит в 4
            этапа.
        </p>
        <div class="platform">
            <div class="platform__items platform__items-1">
                <div class="platform__item platform__item-1 row">
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-1.svg" alt="Подготовка к опросу вовлечённости"
                             title="Подготовка и реализация PR-стратегии">
                    </div>
                    <div class="platform__text col-md-7">
                        <div class="plaform__title-h2">Этап 1. Подготовка к опросу</div>
                        <div class="plaform__title-h3">Подготовка и реализация PR-кампании</div>
                        <p>
                            Happy Job предоставляет клиенту готовую PR-стратегию, в которую уже
                            входят шаблоны коммуникаций: email-рассылки, приглашение к опросу,
                            постеры, скринсейверы, информационные видеоролики, видеообращение
                            высшего руководства и т.д.
                        </p>
                        <p>
                            Мы рассказываем сотрудникам не только о технике прохождения опроса, но
                            и
                            <a href="/blog/o-platforme/anonimnost-v-oprosakh-happy-job/">
                                об анонимности
                            </a>
                            , целях исследования. Даём понять, что за опросом последует целая
                            экосистема зависимых процессов и работы с предложениями для внедрения
                            изменений.
                        </p>
                        <p>
                            Персональный дизайнер и PR-консультант помогут доработать PR-материалы
                            и стратегию под специфику и бренд вашей компании.
                        </p>
                        <div class="graunded">
                            <b> Результат: </b>
                            от
                ...
                <div class="platform__item platform__item-2 row">
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-2.svg" alt="Настройка платформы для опросов"
                             title="Персональный менеджер импортирует в платформу вашу структуру подразделений, назначит доступы для руководителей и HR-специалистов и поможет составить календарь опросов и отчётов.">
                    </div>
                    <div class="platform__text col-md-7">
                        <div class="plaform__title-h3">Настройка платформы</div>
                        <p>
                            Персональный менеджер импортирует в платформу вашу структуру
                            подразделений, назначит доступы для руководителей и HR-специалистов и
                            поможет составить календарь опросов и отчётов.
                        </p>
                        <p>
                            Платформа позволяет осуществить импорт и сопоставление данных
                            исследований других провайдеров.
                        </p>
                        <p>
                            Можно добавить в систему ваши
                            <a href="/hr-blog/6-glavnykh-oshibok-v-oprosakh-sotrudnikov/">
                                индивидуальные вопросы
                            </a>
                            через сервис «Конструктор опросов».
                        </p>
                    </div>
                </div>
            </div>
            <div class="platform__bg-gray platform__items platform__items-2">
                <div class="platform__item platform__item-3 row">
                    <div class="platform__text col-md-7">
                        <div class="plaform__title-h2">Этап 2. Опрос и обратная связь</div>
                        <p>
                            Happy Job доставляет ссылку на опрос сотрудникам по email или sms.
                            Также возможно организовать офлайн-участие.
                        </p>
                        <p>
                            Сотрудники отвечают на вопросы и
                            <a href="/types-of-surveys/poll-feedback/"> пишут предложения </a>
                            со своего компьютера, мобильного устройства или стационарного
                            терминала. Геймифицированный опрос длится 2–7 минут в зависимости от
                            настроек исследования.
                        </p>
                        <div class="graunded">
                            <b> Результат: </b>
                            до
                            <span> 97% </span>
                            удовлетворённость сотрудников прохождением опросов.
                        </div>
                    </div>
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-3.svg"
                             alt="корпоративные исследования и обратная связь от сотрудников"
                             title="Сотрудники отвечают на вопросы и пишут предложения со своего компьютера, мобильного устройства или стационарного терминала. Геймифицированный опрос длится 2–7 минут в зависимости от настроек исследования.">
                    </div>
                </div>
                <div class="platform__item platform__item-4 row">
                    <div class="platform__text col-md-7">
                        <p>
                            Happy Job — это современный инструмент для
                            <a href="/types-of-surveys/engagement-survey/">
                                изучения вовлечённости
                            </a>
                            и настроя персонала, а также возможность для сотрудников на 100%
                            анонимно или открыто высказать идеи, предложения или критику в ходе
                            основного опроса.
                        </p>
                    </div>
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-4.svg" alt="Удовлетворенность сотрудников работой"
                             title="Happy Job — это современный инструмент для изучения вовлечённости и настроя персонала, а также возможность для сотрудников на 100% анонимно или открыто высказать идеи, предложения или критику в ходе основного опроса.">
                    </div>
                </div>
            </div>
            <div class="platform__items platform__items-3">
                <div class="platform__item platform__item-5 row">
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-5.svg"
                             alt="Отчёты для руководителей и HR-специалистов"
                             title="Руководители видят обезличенные результаты выбранных подразделений с использованием дерева оргструктуры.">
                    </div>
                    <div class="platform__text col-md-7">
                        <div class="plaform__title-h2">
                            Этап 3. Отчёты для руководителей и HR-специалистов
                        </div>
                        <p>
                            Руководители и HR-специалисты в режиме реального времени получают
                            результаты опроса через личный кабинет, согласно назначенному уровню
                            доступа.
                        </p>
                        <p>
                            Руководители видят обезличенные результаты выбранных подразделений с
                            использованием дерева оргструктуры. Доступна выгрузка любых
                            брендированных отчётов и аналитики для подразделения в PPT, PDF и XLS
                            «в 1 клик».
                        </p>
                        <br>
                    </div>
                </div>
                <div class="platform__item platform__item-6 row">
                    <div class="platform__img col-md-5">
                        <img src="/img/happy-job/images/platform/plat-6.svg" alt="Анкетирование персонала"
                             title="Платформа также предоставляет встроенную аналитику и рекомендации по улучшению метрик вовлечённости и лояльности, а также контент-анализ идей и предложений сотрудников с применением фильтров и тегов.">
                    </div>
                    <div class="platform__text col-md-7">
                        <p>
                            Платформа также предоставляет встроенную аналитику и рекомендации по
                            улучшению метрик вовлечённости и лояльности, а также контент-анализ
                            идей и предложений сотрудников с применением фильтров и тегов.
                        </p>
                    </div>
                </div>
            </div>
            <div class="platform__bg-gray platform__items platform__items-4">
                <div class="plaform__title-h2">
                    Этап 4. Развитие вовлечённости и лояльности
                </div>
                <div class="plaform__title-description">
                    Встроенные сервисы не дадут руководителям забывать о
                    <a href="/hr-blog/kakie-oshibki-vozmozhny-v-programme-vovlechennosti-i-kak-ikh-izbezhat/">
                        работе над вовлечённостью
                    </a>
                    и ответят на вопрос «Как развивать?»
                </div>
                <div class="platform__vovl platform-vovl row">
                    <div class="platform-vovl__item col-md-6 col-lg-3">
                        <div class="platform-vovl__img">
                            <img src="/img/happy-job/images/platform/plat-v-1.svg" alt="HR-стратегия"
                                 title="Определяем настрой персонала для планирования активностей по приоритетным направлениям">
                        </div>
                        <div class="platform-vovl__text">
                            Карта настроений групп персонала для планирования активностей по
                            приоритетным направлениям
                        </div>
                    </div>
                    <div class="platform-vovl__item col-md-6 col-lg-3">
                        <div class="platform-vovl__img">
                            <img src="/img/happy-job/images/platform/plat-v-2.svg"
                                 alt="Развитие вовлечённости и лояльности"
                                 title="Отчет по метрикам вовлечённости персонала">
                        </div>
                        <div class="platform-vovl__text">
                            Аналитические отчёты по
                            <a href="/hr-blog/chto-takoe-drayvery-vovlechennosti-kak-ikh-vyyavit-i-proanalizirovat/">
                                драйверам
                            </a>
                            — приоритетам развития вовлечённости и лояльности
                        </div>
                    </div>
                    <div class="platform-vovl__item col-md-6 col-lg-3">
                        <div class="platform-vovl__img">
                            <img src="/img/happy-job/images/platform/plat-v-3.svg" alt="Сравнение компаний"
                                 title="Бенчмарки для сравнения с лучшим, худшими и средними данными внутри компании и по отрасли / России">
                        </div>
                        <div class="platform-vovl__text">
                            <a href="/hr-blog/vneshnie-i-vnutrennie-benchmarki-na-chto-stoit-orientirovatsya-kompanii/">
                                Бенчмарки
                            </a>
                            для сравнения с лучшим, худшими и средними данными внутри компании и
                            по отрасли / России
                        </div>
                    </div>
                    <div class="platform-vovl__item col-md-6 col-lg-3">
                        <div class="platform-vovl__img">
                            <img src="/img/happy-job/images/platform/plat-v-4.svg" alt="План работ руководителя"
                                 title="Развитие сотрудников">
                        </div>
                        <div class="platform-vovl__text">
                            План работ руководителя позволяет не забывать о развитии и идеях
                            сотрудников
                        </div>
                    </div>
                </div>
...
<!-- endrender about-service/method//-->
