<?php $this->title = 'Контакты технической поддержки сервиса развития вовлечённости персонала Happy Job'; ?>
    ...
    <main>
        ...
        <span itemprop="name" style="">
          Главная</span>
                    ...
                    <li class="breadcrumbs-item breadcrumbs-links-contacts" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                <span itemprop="name">
                  Контакты</span>
                    ...
                    <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        <span itemprop="name">Клиентская поддержка</span>
        ...
        <div class="deliveryBlock__title">Клиентская поддержка</div>
        <table class="table">
            ...
            <tr>
                <th>Email</th>
                <td><a href="mailto:support@happy-inc.ru">support@happy-inc.ru</a></td>
            </tr>

            <tr>
                <th>Телефон</th>
                <td><a href="tel:+74952150890">+7 (495) 215-08-90</a></td>
            </tr>
