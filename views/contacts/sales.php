<?php $this->title = 'Контакты отдела продаж сервиса развития вовлечённости персонала Happy Job'; ?>
    ...
    <main>
        ...
        <span itemprop="name" style="">
          Главная</span>
                        ...
                        <li class="breadcrumbs-item breadcrumbs-links-contacts" itemprop="itemListElement" itemscope
                            itemtype="https://schema.org/ListItem">
                <span itemprop="name">
                  Контакты</span>
            ...
            <div class="deliveryBlock__title">Офис</div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <address>
                                    <a href="https://yandex.ru/maps/-/CBBnJVVP8B">117587, Россия, Москва, Варшавское ш.,
                                                                                  118к1, 10 эт</a>
                                </address>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>Для подключения к сервису</th>
                            <td><a href="mailto:sales@happy-job.ru">sales@happy-job.ru</a></td>
                        </tr>
                        <tr>
                            <th>Телефон</th>
                            <td><a href="tel:+74956468389">+7(495) 646-83-89</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col-md-6">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="https://yandex.ru/map-widget/v1/-/CCUbvXulkD" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </section>
