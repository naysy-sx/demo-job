<?php $this->title = 'Стоимость опросов для персонала | онлайн-сервис Happy Job'; ?>
...
<div class="container mainc">
    <main>
        ...
        <div class="page-top wide-container page-top_withbreadcrumbs page-top_withform">
            <div class="container">
        ...
        <span itemprop="name">
          Главная</span>
                ...
                <div class="page-top__title">
                    <h1>
                        Гибкая система цен <br>под <span>ваши</span> задачи
                    </h1>
                </div>
                <div class="page-top__text">
                    <p style="margin: 0;"></p><p>Стоимость платформы на 12 месяцев составляет всего <b>199</b> тыс. рублей <br>для команд до <b>200</b> человек.</p><p>Для численности от 200 человек проект рассчитывается индивидуально. Пожалуйста, <b>отправьте заявку</b> и мы подготовим детальное предложение.</p>

                </div>
                <div class="page-top__form">
                    <style>
        ...
        <div class="prices-stages wide-container">
            <div class="container">
                <h2 class="section-title prices-stages__title">
                    Опции, доступные каждому клиенту
                </h2>
                <div class="prices-stages__text">
                    Проводите научные, современные опросы сотрудников – безопасно и при полной поддержке<br>
                    профессионалов на каждом этапе проекта
                </div>
                <div class="prices-stages__block">
                    <div class="prices-stages__item">
                        <div class="prices-stages__item-title">
                            Подготовка
                        </div>
                        <div class="prices-stages__item-list">
                            <ul>
                                <li>Импорт вашей оргструктуры</li>
                                <li>Набор лучших работающих PR-кампаний</li>
                                <li>Гибкий календарь исследований</li>
                                <li>Полная методическая и тех. поддержка 24/7</li>
                            </ul>
                        </div>
                    </div>
                    <div class="prices-stages__item">
                        ...
                        <div class="prices-stages__item-list">
                            <ul>
                                <li>Адаптация анкеты под ваших сотрудников</li>
                                <li>Геймификация опроса</li>
                                <li>Инструменты повышения участия в опросе</li>
                                <li>100% защита анонимности</li>
                                <li>Отраслевые анкеты</li>
                                <li>Все известные способы доставки опроса</li>
                            </ul>
                        </div>
                    </div>
                    <div class="prices-stages__item">
                        ...
                        <div class="prices-stages__item-list">
                            <ul>
                                <li>Доставка результатов каждому руководителю</li>
                                <li>Alarm-интеллект в отчетах</li>
                                <li>Внутренние бенчмарки по компании и функциям</li>
                                <li>Внешние бенчмарки по отрасли и по стране</li>
                                <li>Контент- и контекст- анализ</li>
                                <li>Конструктор презентации итога исследования</li>
                            </ul>
                        </div>
                    </div>
                    <div class="prices-stages__item">
                        ...
                        <div class="prices-stages__item-list">
                            <ul>
                                <li>Встроенные рекомендации</li>
                                <li>Приоритеты развития метрик (1,2,3)</li>
                                <li>Сравнение периодов и корреляции</li>
                                <li>Онлайн-план работ</li>
                                <li>Мониторинг активности руководителей</li>
                                <li>Консалтинговая поддержка стандарт, приоритет, VIP</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="prices-stages__button">
                    <a href="/advantages/" class="button-w-arrow">
        ...
        <style>
            ...
            .prices-stages .container{
                padding: 0;
            }
            .prices-stages__title{
                text-align: center;
            }
            .prices-stages__text{
                text-align: center;
            ...
            .prices-stages__item:nth-child(1)::before{
                background: #a0bf3d;
            }
            .prices-stages__item:nth-child(2)::before{
                background: #7cbf3c;
            }
            .prices-stages__item:nth-child(3)::before{
                background: #3cbf3f;
            }
            .prices-stages__item:nth-child(4)::before{
                background: #3cbca3;
            }
            .prices-stages__item-title{
                font-weight: 900;
                font-size: 31px;
                line-height: 1;
                text-align: center;
            ...
            .prices-stages__item-title::after{
                content: '';
                position: absolute;
                bottom: 0;
                left: 20px;
            ...
            .prices-stages__item-list{
                padding: 30px 14px 20px 16px;
            }
            .prices-stages__item-list ul{
                margin: 0;
                padding: 0;
            }
            .prices-stages__item-list ul li{
                font-size: 13px;
                line-height: 1.4;
            ...
            .prices-stages__item-list ul li::before{
                content: '';
                position: absolute;
                left: 0;
                top: 50%;
                ...
                background-position: center;
                background-repeat: no-repeat;
                background-image: url("data:image/svg+xml,%3Csvg width='10' height='7' viewBox='0 0 10 7' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cline x1='1.12054' y1='2.8357' x2='4.27463' y2='6.04533' stroke='%2361C139'/%3E%3Cline x1='9.341' y1='0.765701' x2='3.62894' y2='6.09228' stroke='%2361C139'/%3E%3C/svg%3E");
                background-size: 50% auto;
            }
            .prices-stages__button{
                display: flex;
                justify-content: center;
                margin-top: 39px;
            }
            ...
            @media (max-width: 991px) {
                ...
                .prices-stages__title br,
                .prices-stages__text br{
                    display: none;
                }
            }
        </style>
            ...
            <div class="container">
                ...
                <div class="prices-facts__block">
                    ...
                    <div class="prices-facts__item">
                        ...
                        <div class="prices-facts__item-link">
                            <a href="https://happy-job.ru/blog/pochemu_online_construktory_ne_podhodyat/" target="_blank" class="button-w-arrow">
                                Подробнее
                            </a>
                        </div>
                    </div>
        ...
        <div class="prices-clients wide-container">
            <div class="container">
                <h2 class="section-title prices-clients__title">
                    Послушайте, что говорят клиенты
                </h2>
                <div class="prices-clients__block">
                    <div>
                        <div class="prices-clients-case">
                            <div class="prices-clients-case__left">
                                <div class="prices-clients-case__top">
                                    <div class="prices-clients-case__images">
                                        <div class="prices-clients-case__photo">
                                            <img src="/img/business-effect/evroplan-person.png" alt="Анаит Говорина">
                                        </div>
                                        <div class="prices-clients-case__logo">
                                            <img src="/img/business-effect/evroplan-logo.jpg" alt="Лого Европлан" class="eplogo">
                                        </div>
                                    </div>
                                    <div class="prices-clients-case__person">
                                        <div>Анаит Говорина</div>
                                        Директор департамента по работе с персоналом, Европлан
                                    </div>
                                </div>
                                <div class="prices-clients-case__bottom">
                                    <p>Лизинг, 4 500 сотрудников</p>
                                    <p>6 лет с Happy Job</p>
                                </div>
                            </div>
                            <div class="prices-clients-case__right">
                                <div class="prices-clients-case__info">
                                    <div>в <span>2</span> раза</div>
                                    снизили уровень текучести
                                </div>
                                <div class="prices-clients-case__info">
                                    <div>с <span>65%</span> до <span>95%</span></div>
                                    вырос индекс вовлеченности персонала
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="prices-clients-case">
                            <div class="prices-clients-case__left">
                                <div class="prices-clients-case__top">
                                    <div class="prices-clients-case__images">
                                        ...
                                        <div class="prices-clients-case__logo">
                                            <img src="/img/business-effect/technonikol-logo.jpg" alt="Лого Технониколь" class="techlogo">
                                        </div>
                                    </div>
                                    <div class="prices-clients-case__person">
                                        <div>Юлия Корочкина</div>
                                        HRD, TC Технониколь
                                    </div>
                                </div>
                                <div class="prices-clients-case__bottom">
                            ...
                            <div class="prices-clients-case__right">
                                ...
                                <div class="prices-clients-case__info">
                                    <div>с <span>37%</span> до <span>82%</span></div>
                                    вырос % успешных внутренних тестов и экзаменов
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="prices-clients-case">
                            <div class="prices-clients-case__left">
                                <div class="prices-clients-case__top">
                                    <div class="prices-clients-case__images">
                                        ...
                                        <div class="prices-clients-case__logo">
                                            <img src="/img/business-effect/magnit-logo.jpg" alt="Лого Магнит" class="magnitlogo">
                                        </div>
                                    </div>
                                    <div class="prices-clients-case__person">
                                        <div>Вера Долгова</div>
                            ...
                            <div class="prices-clients-case__right">
                                <div class="prices-clients-case__info">
                                    Программа развития вовлечённости и лояльности дала рост всех целевых показателей.
                                </div>
                                <div class="prices-clients-case__info">
                                    Лояльность <span>+9.3%</span>
                                </div>
                                <div class="prices-clients-case__info">
                                    eNPS <span>+19.9%</span>
                                </div>
                ...
                <div class="prices-clients__button">
                    <a href="/cases/" class="button-w-arrow">
                        Смотрить все кейсы
                    </a>
                </div>
            </div>
        ...
        <style>
            ...
            .prices-clients .container{
                padding: 0;
            }
            .prices-clients__title{
                text-align: center;
            }
            .prices-clients__block{
                margin: 59px auto 0;
                padding-bottom: 55px;
            }
            .prices-clients__arrow{
                position: absolute;
                top: 37.5%;
                width: 60px;
                height: 60px;
            ...
            .prices-clients__arrow_prev{
                left: -82px;
                transform: scale(-1,1);
            }
            .prices-clients__arrow_next{
                right: -82px;
            }
            .prices-clients__arrow svg{
                fill: #c6ced1;
                display: block;
                width: 100%;
                height: 100%;
            ...
            .prices-clients__arrow:hover svg{
                transform: translateX(8%);
            }
            .prices-clients__block .slick-dots{
                position: absolute;
                left: 0;
                bottom: 0;
                width: 100%;
            ...
            .prices-clients__block .slick-dots li{
                margin: 0 10px;
            }
            .prices-clients__block .slick-dots button{
                width: 12px;
                height: 12px;
                min-width: 12px;
                outline: none;
            ...
            .prices-clients-case__left{
                width: 43.9%;
                display: flex;
                flex-direction: column;
                justify-content: space-between;
                padding: 47px 20px 60px 65px;
                position: relative;
            }
            .prices-clients-case__left::after{
                content: '';
                position: absolute;
                top: 36px;
                bottom: 48px;
            ...
            .prices-clients-case__images{
                display: flex;
                align-items: center;
                position: relative;
                left: -9px;
            }
            .prices-clients-case__photo{
                width: 75px;
                height: 75px;
                border-radius: 50%;
                overflow: hidden;
            ...
            .prices-clients-case__photo img{
                width: 100%;
                height: 100%;
                object-fit: cover;
                object-position: center;
            }
            .prices-clients-case__logo{
                height: 77px;
            }
            .prices-clients-case__logo img{
                max-width: 223px;
                max-height: 100%;
                position: relative;
                top: 50%;
            ...
            .prices-clients-case__logo .eplogo{
                transform: none;
                top: 10px;
                margin-left: 0;
            }
            .prices-clients-case__logo .magnitlogo{
                max-width: 185px;
            }
            .prices-clients-case__logo .techlogo{
                max-width: 63px;
            }
            .prices-clients-case__person{
                position: relative;
                z-index: 1;
                margin-top: 19px;
                color: #8b8b8b;
            }
            .prices-clients-case__person div{
                font-weight: 700;
                color: #383838;
                margin-bottom: 16px;
            }
            .prices-clients-case__bottom p{
                margin: 0 0 16px;
                color: inherit;
            }
            .prices-clients-case__right{
                flex: 1;
                display: flex;
                flex-direction: column;
                justify-content: center;
            ...
            .prices-clients-case__info{
                font-size: 27px;
                line-height: 1.2;
                letter-spacing: -0.01em;
                margin: 25px 0;
            }
            .prices-clients-case__info div{
                font-weight: 700;
                font-size: 32px;
            }
            .prices-clients-case__info span{
                font-weight: 700;
                font-size: 48px;
            }
            ...
            @media (max-width: 992px) {
                ...
                .prices-clients-case__info:last-child{
                    margin-bottom: 10px;
                }
                .prices-clients-case__info div{
                    font-size: 24px;
            ...
            @media (max-width: 456px){
                ...
                .prices-clients-case__right,.prices-clients-case__left{
                    padding: 30px 15px;
                }
            }
        </style>
        <div class="question-block">
            <div class="wide-container">
                ...
                <div class="question-block__question"></div>
                <div class="question-block__text">
                    Возможно мы уже на них ответили на странице «Часто задаваемые вопросы»
                </div>
                <div class="question-block__button">
                    <a href="/faq/" class="button-w-arrow">
                        Перейти
                    </a>
                </div>
            </div>
        ...
        <style media="screen">
            ...
            .question-block .wide-container::before{
                content: '';
                position: absolute;
                z-index: 0;
                left: 0;
                ...
                width: 100%;
                height: 100%;
                background: rgb(250,248,251); /* Old browsers */
                background: -moz-linear-gradient(left,  rgba(250,248,251,1) 0%, rgba(243,244,246,1) 100%); /* FF3.6-15 */
                background: -webkit-linear-gradient(left,  rgba(250,248,251,1) 0%,rgba(243,244,246,1) 100%); /* Chrome10-25,Safari5.1-6 */
                background: linear-gradient(to right,  rgba(250,248,251,1) 0%,rgba(243,244,246,1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
                filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#faf8fb', endColorstr='#f3f4f6',GradientType=1 ); /* IE6-9 */
            }
            .question-block .wide-container div{
                position: relative;
                z-index: 1;
            }
            ...
            .question-block__question{
                ...
                background-repeat: no-repeat;
                background-size: contain;
                background-image: url(/img/p/prices/question.png);
                margin: 0 20px;
            }
