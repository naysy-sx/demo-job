<?php $this->title = 'Happy Индекс - что это и зачем он нужен? | Happy Job'; ?>
<div class="container mainc">
    <main>

        <style>
            @media (max-width: 480px ){
                #super-title-wrap .hero__button .button.button--red{
                    margin-top: 1rem;
        ...
        <div class="top-baner wide-container" id="super-title-wrap">
            <img src="/img/p/happy-index/happy_index_header.jpg">
            <div class="container">
                <div class="title wtext">
                    <h1>Happy <br>Индекс</h1>
                    <p style="font-size: 1rem; margin: 1rem 0;">сводная метрика вовлечённости и лояльности, <br>разработанная экспертами Happy Job в 2017 году</p>
                    <div class="hero__button">
                <span class="contact button button--red button--bold" onclick="ym(46152993,'reachGoal','innerpages_event_click')" data-rtype="demo" data-fancybox="" data-src="#main-modal" href="javascript:;">
          ...
          Главная</span>
            ...
            Методика</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                ...
                                <span itemprop="name">Happy Индекс</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        <li>
                            <a href="#title0"> Что такое Happy Индекс </a>
                        </li>
                        <li>
                            <a href="#title_benchmark"> Happy Индекс Бенчмарк </a>
                        </li>
                        <li>
                            <a href="#title1"> Зачем нужен Happy Индекс </a>
                        </li>
                        <li>
                            <a href="#title2"> Матрица Happy Индекс </a>
                        </li>
                        <li>
                            <a href="#title3"> Как применять Happy Индекс </a>
                        </li>
                    </ul>
                </aside>
            </div>
        ...
        <span itemprop="name" style="">
          Главная</span>
            ...
            Методика</span>
                    ...
                    <h2 id="title0">Что такое Happy Индекс</h2>
                    <p>
                        Happy Индекс — уникальный индекс, ставший эволюцией технологий исследования вовлечённости. Индекс позволяет выделить «золотой» фонд компании, а также определиться с HR-стратегией.
                    </p>
                    <p>
                        Happy Индекс рассчитывается путем суммирования количества вовлеченных сотрудников с высокой и средней степенью и лояльных с высокой, средней и низкой степенью.
                    </p>
                    <p>
                        Медиана по индексу в России за 2022 год среди более 800 компаний составляет 70.7%
                    </p>
                    <img src="/img/p/happy-index/hi_1_new.svg" alt="Happy Индекс по России за 2022 год" title="Happy Индекс по России за 2022 год">
                        ...
                        <div class="comparecalc__info">
                            ...
                            <div class="comparecalc__form">
                                <div class="comparecalc__form-title">
                                    Сравните Ваш Happy Индекс с показателем по России
                                </div>
        ...
        <div class="comparecalc__form-col">
          ...
          <span></span>
                        ...
                        <div class="comparecalc__calcblock">
                            <div class="comparecalc__calc" id="compareCalc" data-average="72">
                    ...
                    </script>      <h2 id="title1">Зачем нужен Happy Индекс</h2>
                    <p>
                        Индекс нужен для характеристики соотношения лояльности и вовлечённости. Понимание этого соотношения позволяет объективно оценивать атмосферу в компании, внедрять решения и практики, способные улучшить продуктивность и бизнес показатели любой организации.
                    </p>
                    <p>
                        Сотрудник может быть лояльным, но не вовлеченным. Например, он планирует работать в компании в ближайшие годы, надеется на повышение и рекомендует компанию знакомым трудоустройству. При этом человек не стремится превосходить ожидания, некачественно выполняет работу и без инициативен.
                    </p>
                    <p>
                        Или, наоборот, сотрудник может быть вовлеченным, но не лояльным. Например, он отлично справляется с работой и перевыполняет KPI, но планирует в ближайшее время уйти к конкурентам.
                    </p>
                    <div class="definition-block">
                        <div class="definition-block__icon i1" style="background-image:url(/img/p/happy-index/icon1.svg);"></div>
                        <div class="definition-block__text">
                            <b>Лояльность</b> — преданность компании, готовность рекомендовать ее и оставаться в ней неопределенно долго.
                        </div>
                    </div>
                    <div class="definition-block">
                        <div class="definition-block__icon i2" style="background-image:url(/img/p/happy-index/icon2.svg);"></div>
                        <div class="definition-block__text">
                            <b>Вовлечённость</b> — эмоциональное и интеллектуальное состояние, при котором сотрудник стремится выполнять свою работу как можно лучше.
                        </div>
                    </div>
                    <p>
                        Соответственно индекс лояльности сообщает о том, испытывают ли сотрудники гордость за компанию, станут ли поддерживать организационные и стратегические изменения, сохранят ли верность компании даже в трудные времена.
                    </p>
                    <p>
                        Индекс вовлечённости показывает, ощущают ли сотрудники свою работу как призвание, готовы ли вкладывать время и силы в профессиональное развитие. Он также косвенно показывает, создает ли сама компания комфортные условия труда, при которых сотрудникам легко быть вовлеченными в свою работу.
                    </p>
                    <p>
                        Индексы лояльности и вовлечённости не могут обеспечить руководителей исчерпывающей и точной информацией для принятия решений. Поэтому возникла необходимость <b>в новом HR-индексе</b>, который объединил бы в себе и лояльных сотрудников, и вовлеченных.
                    </p>

                    <h2 id="title2">Матрица Happy Индекс</h2>
                    <p>
                        Платформа Happy Job позволяет не просто рассчитать Happy Индекс, но и разделить сотрудников, в зависимости от результатов исследования лояльности и вовлечённости, на 9 групп, составляющих матрицу Happy Индекс.
                    </p>
                    <p>
                        Матрица сформирована по результатам опросов, проведенных в компании, и позволяет оценить, какие группы сотрудников преобладают.
                    </p>
                    <div class="matrix-cards">
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                <div class="matrix-cards__item-front">
                                    <div class="matrix-cards__card">
                                        Вовле­ченный <br>
                                        и лояльный
                                    </div>
                                </div>
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Наиболее ценный кадровый ресурс.
                                        Такой сотрудник одновременно высокопродуктивен и предан компании.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Работает в продуктивной среде, но не разделяет ценностей компании. Увлечен своей работой, но не лоялен к работодателю.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Находится в продуктивной среде, выполняет свою работу качественно и в срок, но не стремится сделать больше, чем требуется.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                <div class="matrix-cards__item-front">
                                    <div class="matrix-cards__card">
                                        Слабововле­ченный <br>
                                        и лояльный
                                    </div>
                                </div>
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Предан компании, но отсутствие продуктивной среды не позволяет ему реализовать свои знания и навыки на 100%.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Работает в непро­дуктивной среде и не показывает высоких результатов. Ценностей компании также не разделяет.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                <div class="matrix-cards__item-front">
                                    <div class="matrix-cards__card matrix-cards__card_grey">
                                        Слабововле­ченный <br>и нело­яльный
                                    </div>
                                </div>
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Работает в непро­дуктивной среде и не вовлечен в процесс. Он нелоялен к компании и не рекомендует ее как место работы знакомым.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Заложник ситуации: критически непродуктивная среда и окружение мешают ему эффективно работать, но тем не менее он сохраняет лояльность к компании.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Работает в критически непродуктивной среде, не является продуктивным и не разделяет ценностей работодателя.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-cards__item">
                            <div class="matrix-cards__item-wrap">
                                ...
                                <div class="matrix-cards__item-back">
                                    <div class="matrix-cards__card">
                                        Наихудшая из всех комбинаций. Такой сотрудник неэффективен и нелоялен к компании. Он будет мешать команде, тянуть ее вниз.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="matrix-source">
                            Источник: книга Алексея Клочкова «Вовлечённость и лояльность персонала от А до Я»
                        </div>
                    </div>
                    <p>
                        В отчетах для пользователей платформы Happy Job матрица выглядит так:
                    </p>
                    <img src="/img/p/happy-index/hi_2.jpg" alt="Матрица в отчетах для пользователей платформы Happy Job" title="Матрица в отчетах для пользователей платформы Happy Job">

                    <h2 id="title3">Как применять Happy Индекс</h2>
                    <p>
                        Получив на руки матрицу Happy Индекс, руководитель может сосредоточить внимание на тех мерах, которые улучшат ситуацию.
                    </p>
                    <p>
                        Опираться при этом следует на кадровую политику и задачи, стоящие перед компанией. Например, если HR-стратегия в организации — потребительская и большая часть сотрудников в группах невовлеченных и нелояльных, приоритетными должны стать меры, направленные на развитие  <a href="/types-of-surveys/engagement-survey/">продуктивности среды</a>:
                    </p>
                    <div class="list-in-frame">
                        <ul>
                            <li>улучшение условий труда;</li>
                            <li>оптимизация бизнес-процессов;</li>
                            <li>проведение тренингов для руководителей по управленческим компетенциям;</li>
                            <li>частая, регулярная и грамотная обратная связь;</li>
                            <li>признание заслуг;</li>
                            <li>проведение бесед 1-on-1, включающие обсуждение карьерного трека и профессиональное развитие каждого сотрудника;</li>
                            <li>мероприятия по поддержанию life-work баланса;</li>
                            <li>оздоровление психологической атмосферы в коллективе.</li>
                        </ul>
                    </div>
                    <p>
                        Потребительская HR-стратегия предполагает, что жизненный цикл сотрудника в компании короток, так что в первую очередь от него нужно добиться максимальной продуктивности.
                    </p>
                    <p>
                        Если же принята HR-стратегия, направленная на долгосрочное сотрудничество, партнерство и удержание ценных специалистов, приоритетными становятся меры по <a href="/types-of-surveys/loyalty-survey/">повышению лояльности</a>:
                    </p>
                    <div class="list-in-frame">
                        <ul>
                            <li>выяснение причин низкой лояльности сотрудников посредством грамотного проведения встреч 1-on-1;</li>
                            <li>анализ критики, идей и предложений, полученных в результате опросов вовлечённости и лояльности;</li>
                            <li>совместный с командой поиск решений выявленных проблем;</li>
                            <li>внедрение предложенных решений;</li>
                            <li>регулярные встречи с сотрудниками для обсуждения принятых мер и планов по внедрению дальнейших изменений с конкретными сроками;</li>
                            <li>информирование сотрудников о том, что происходит в компании, — успехах, сложностях, решениях вышестоящего руководства;</li>
                            <li>создание традиций и грамотное, ненавязчивое командообразование.</li>
                        </ul>
                    </div>
                    <p>
                        На платформе Happy Job вы найдете рекомендации от наших экспертов, которые помогут улучшить метрики. Рекомендации дополняет встроенный План действий и инструменты самоконтроля, благодаря чему руководители добиваются целей, стоящих перед компанией, и управленческая нагрузка существенно не возрастает.
                    </p>
                </main>
            </div>
        </div>
        <style media="screen">
            ...
            .definition-block__icon{
                background-repeat: no-repeat;
                background-position: left;
                background-size: contain;
                width: 81px;
            }
            .definition-block__icon.i1{
                height: 55px;
            }
            .definition-block__icon.i2{
                height: 49px;
            ...
            .matrix-cards__item:nth-child(3n){
                margin-right: 0;
            }
            .matrix-cards__item-front{
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            .matrix-cards__item-front .matrix-cards__card{
                font-size: 16px;
                background: #c2f4a2;
                font-weight: 900;
            }
            .matrix-cards__item-front .matrix-cards__card_grey{
                background: #c6c6c6;
            }
            .matrix-cards__item-back .matrix-cards__card{
                background: rgba(74,74,74,0.05);
                font-size: 13px;
                line-height: 1.5;
            }
