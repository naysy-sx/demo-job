<?php $this->title = 'Отчет по трендам вовлеченности и лояльности персонала в России'; ?>
...
<div class="container mainc">
    <main>
        ...
        <div class="main-picture wide-container">
            <picture>
                <source srcset="/img/pages/trends/mobile_header.svg" media="(max-width: 577px)">
                <source srcset="/img/pages/trends/trends_2024_tablet_bg.png" media="(max-width: 1200px)">
                <img src="/img/pages/trends/trends_2024_bg.png">
            </picture>
        </div>
        <div class="row">
        ...
        <span itemprop="name">
          Главная</span>
                        ...
                        <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <span itemprop="name">Отчет по трендам вовлеченности и лояльности персонала в России</span>
                ...
                <p>В условиях быстро меняющегося рынка, дефицита трудовых ресурсов и борьбы за таланты работа с вовлеченностью и лояльностью в 2024 году становится еще важнее. С какими вызовами столкнется HR-сфера и чего ждать? Как адаптироваться, формировать сильные команды и привлекать в компанию лучших?</p>
                <p>Команда Happy Job провела исследование, в котором приняли участие более 75% сотрудников 800 компаний из 32 отраслей, чтобы дать экспертный взгляд на тренды в развитии метрик, показать причинно-следственные связи и предложить практические рекомендации для руководителей и HR-специалистов.</p>

                <h3 class="trend-h3">Скачайте наш отчет по трендам <span>вовлеченности и лояльности в России 2022-2023 и узнайте:</span></h3>

                <ol>
                    <li>Как менялись тенденции в основных HR-индексах;</li>
                    <li>Кто стал лидером рейтинга роста лояльности по отраслям;</li>
                    <li>Причины роста лояльности;</li>
                    <li>Как менялся eNPS в 2023 году;</li>
                    <li>Что ждет HR-сферу в 2024 году (прогнозы и советы).</li>
                </ol>

                <a class="trend-button">Получите отчет</a>
                ...
                <div class="trend-form -collapsed">
                    <style>
                    ...
                    <form id="trend" class="c-form" data-parsley-validate>
                        <h2>Заголовок по умолчанию</h2>

                        <ul class="c-form-list">
                            <li class="c-form-item">
                                <input type="hidden" name="form-id" value="trend">
                            </li>
                            <li class="c-form-item">
                        ...
                        <button id="trend-submit" type="submit" class="button-default">Отправить</button>
                    ...
                    <script>
                        $(function() {
                            ...
                            let inputFields = document.querySelectorAll('#trend input[type="tel"]');
                            ...
                            const sendForm = (formNode, formData, formNodeID, formURL) => {
                                fetch('/ajax', {
                                    ...
                                    .then(function(data) {
                                        ...
                                        $("#trend").find('input[type="text"], input[type="phone"], textarea').val('');
                            ...
                            // 1
                            $('#trend input').on('input', function() {
                                const Form = $('#trend').parsley();
                            });
                            ...
                            function formSubmitHandler(event) {
                                ...
                                const formNode = document.getElementById('trend');
                                const formData = new FormData(formNode);
                                const formNodeID ='trend';
