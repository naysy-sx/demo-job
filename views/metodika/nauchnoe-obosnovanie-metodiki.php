<?php $this->title = 'Научное обоснование методики исследования вовлечённости сотрудников| Happy Job'; ?>

<div class="container mainc">
    <main>
        <div class="top-baner wide-container" id="super-title-wrap">
            <img src="/img/happy-job/images/metodika/header_m.jpg">
            <div class="container">
                <div class="title wtext">
                    <h1>Научное обоснование методики</h1>

                    <div class="hero__button">
                        <a class="button-default button-modal" data-button-text="Попробовать бесплатно" data-fancybox data-src="#main-modal" href="javascript:;" onclick="ym(46152993,'reachGoal','innerpages_event_click')">Расскажите мне больше</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <span itemprop="name" style="">
          Главная</span>
                            ...
                            <li class="breadcrumbs-item breadcrumbs-links-metodika" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                <span itemprop="name">
                  Методика</span>
                            ...
                            <li class="breadcrumbs-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <span itemprop="name">Научное обоснование методики</span>
                ...
                <aside class="anchor-menu">
                    <ul>
                        <li>
                            <a href="#title0"> О
                                               платформе Happy Job </a>
                        </li>
                        <li>
                            <a href="#title1"> Научный подход в исследованиях Happy Job </a>
                        </li>
                        <li>
                            <a href="#title2"> Геймификация
                                               в опросах Happy Job </a>
                        </li>
                        <li>
                            <a href="#title3"> Что можно узнать о сотрудниках после опросов Happy Job </a>
                        </li>
                        <li>
                            <a href="#title4"> Опросы сотрудников на Happy Job дают точные результаты </a>
                        </li>
                        <li>
                            <a href="#title5"> Как научный подход
                                               реализован на платформе Happy Job </a>
                        </li>
                        <li>
                            <a href="#title6"> О компании Happy Job в цифрах </a>
                        </li>
                    </ul>
                </aside>
                <div class="loadarticle">
                    <div class="loadarticle__block">
                        <div class="loadarticle__logo"></div>
                        <div class="loadarticle__title">Научное обоснование методики</div>
                        <div class="loadarticle__cover" style="background-image:url('/img/happy-job/images/metodika/header_m.jpg')"></div>
                    </div>
                    <a href="/pdf/nauchnoe-obosnovanie-metodiki-happy-job.pdf" download class="loadarticle__button">Скачать статью в PDF</a>
                </div>

                <a href="/vovlechennost-i-loyalnost-personala-ot-do-ya/" class="sidevideo">
                    <video playsinline autoplay muted>
                        <source src="/videos/sidevideo/book.webm" type="video/webm">
                        <source src="/videos/sidevideo/book.mp4" type="video/mp4">
                    </video>
                </a>
                <style media="screen">
                    .sidevideo{
          ...
          Главная</span>
                ...
                <span itemprop="name">
                  Методика</span>
                    ...
                    <h2 id="title0">О
                                    платформе Happy Job</h2>
                    <p>
                        Платформа Happy Job — удобное решение для измерения вовлечённости и
                        лояльности персонала, с помощью которого можно менять корпоративную
                        культуру к лучшему. Благодаря данным, которые позволяет собирать Happy
                        Job, вы сможете своевременно устранять проблемы в компании,
                        совершенствовать рабочую среду. Постоянная работа в этой области
                        приведёт к процветанию компании — ведь счастливые, вовлечённые
                        сотрудники работают усерднее, дольше остаются с работодателем и
                        достигают лучших результатов.
                    </p>
                    <p>
                        В основе нашего продукта — современные digital-технологии. Они делают
                        процесс измерения вовлечённости и лояльности персонала точным и простым
                        для пользователей.
                    </p>
                    <p>
                        В Happy Job используются общепризнанные показатели оценки лояльности,
                        eNPS и удовлетворённости*. Также мы создали собственные метрики оценки
                        вовлечённости, применив наш 20-летний консалтинговый и исследовательский
                        опыт.
                        <a href="/img/happy-job/images/metodika/rao.jpg" data-fancybox>
                            Методика Happy Job подтверждена патентом РАО.
                        </a>
                    </p>
                    <p>
                        Наша методика проведения опросов сотрудников была
                        <a href="https://happy-inc.ru/news/Nauchnaya-publikaciya-Alekseya-Klochkova-v-mezhdunarodnom-izdanii-IJSBAR/">
                            описана в статье международного научного журнала фундаментальных и
                            прикладных исследований IJSBAR.
                        </a>
                    </p>
                    <div class="row text-center" style="margin-bottom: 20px">
                        <div class="col-md-6">
                            <a href="/img/happy-job/images/metodika/rao.jpg" data-fancybox title="Методика изучения вовлечённости и лояльности сотрудников Happy Job подтверждена патентом РАО">
                                <div class="certificate-img" style="
                  background-image: url(/img/happy-job/images/metodika/rao.jpg);
                "></div>
                                <span> Посмотреть </span>
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="/img/happy-job/images/metodika/rao2.jpg" data-fancybox title="Методика Happy Job была описана в научном журнале IJSBAR">
                                <div class="certificate-img" style="
                  background-image: url(/img/happy-job/images/metodika/rao2.jpg);
                "></div>
                                <span> Посмотреть </span>
                            </a>
                        </div>
                    ...
                    <p>
                        <i>
                            * В процессе работы над методикой Happy Job были изучены 12 методик
                            мировых провайдеров исследований вовлечённости и лояльности персонала,
                            144 научных исследования и 29 книг.
                        </i>
                    </p>
                    <h2 id="title1">Научный подход в исследованиях Happy Job</h2>
                    <p>
                        Создавая методику Happy Job, мы детально изучили факторы, влияющие на
                        достоверность итоговых данных. Одним из них стала когнитивная нагрузка
                        на респондентов опроса.
                    </p>
                    <h3>Теория когнитивной нагрузки</h3>
                    <p>
                        <strong>
                            Когнитивная нагрузка — объём усилий, который нужно потратить при
                            решении определённой задачи.
                        </strong>
                        Теория когнитивной нагрузки была создана австралийским
                        педагогом-психологом Джоном Свеллером в 1988 году. Он предположил, что
                        метод подачи информации влияет на объём умственных усилий, необходимых
                        для её усвоения.
                    </p>
                    <p>
                        Ресурс человеческого мозга не бесконечен. При решении любых задач —
                        повседневных, академических или рабочих — мы испытываем когнитивную
                        нагрузку. С её увеличением возрастает вероятность ошибки при выполнении
                        заданий, становится сложнее усваивать информацию, принимать решения,
                        оставаться объективными.
                    </p>
                    <h3>Как ведет себя респондент при высокой когнитивной нагрузке?</h3>
                    <p>
                        Исследования вовлечённости и лояльности персонала подчиняются тем же
                        правилам, что и академические или рабочие задачи: чем сложнее опрос, тем
                        больше усилий сотрудники потратят на его прохождение. При этом на объём
                        когнитивной нагрузки будут влиять как сама анкета, так и окружение
                        человека — шум в офисе, состояние устройства, на котором он проходит
                        тест, и так далее.
                    </p>
                    <p>
                        <strong>
                            Высокий уровень когнитивной нагрузки ставит под сомнение результат
                            опроса.
                        </strong>
                        Во-первых, заполняя сложные анкеты, респонденты теряют концентрацию и
                        чаще ошибаются. Во-вторых, у них падает мотивация заканчивать начатое. В
                        результате сотрудники будут выбирать ответы, которые подходят критериям
                        вопроса, но не отражают реального мнения по заданной теме. Полученные в
                        ходе опроса данные не покажут реальной картины настроений в компании.
                    </p>
                    <h3>Восприятие информации респондентом</h3>
                    <p>
                        Современный человек потребляет огромное количество данных. По оценке
                        профессора Мартина Гилберта и его команды из университета Южной
                        Калифорнии,
                        <strong>
                            объём ежедневно получаемой человеком информации уместился бы в 170+
                            печатных изданиях.
                        </strong>
                    </p>
                    <p>
                        Чтобы ориентироваться в этом потоке и снизить когнитивную нагрузку, наш
                        мозг научился выделять главную информацию, а ненужную — блокировать.
                        Например, не замечать рекламу в социальных сетях или быстро находить
                        ключевые фразы в громоздких текстах.
                    </p>
                    <p>
                        Эта способность мозга включается и при прохождении опросов. Крупные,
                        монотонные анкеты с косноязычной формулировкой вопросов плохо
                        воспринимаются:
                    </p>
                    <ul>
                        <li>• внимание сотрудников рассеивается;</li>
                        <li>• задания выполняются формально;</li>
                        <li>
                            • заполнение опроса кажется ненужной работой, которую следует
                            завершить как можно скорее.
                        </li>
                    </ul>
                    <h3>«Клиповая культура» и когнитивная нагрузка</h3>
                    <p>
                        Обилие информации и появление новых каналов её передачи (интернет, видео
                        и др.) способствовали возникновению феномена под названием «клиповая
                        культура», от английского clip — «отрезок», «фрагмент».
                    </p>
                    <p>
                        Главная идея клипового сознания говорит о формировании принципиально
                        новых типов мыслительных процессов в условиях информационного общества.
                        <strong>
                            Носители клипового мышления воспринимают мир через отдельные яркие и
                            запоминающиеся моменты, а не целостно, как при традиционном мышлении.
                        </strong>
                    </p>
                    <p>
                        Данный тренд нужно принимать во внимание, выбирая длину и формат опроса.
                        Громоздкие анкеты старого типа устарели — большинству респондентов
                        сложно сохранять концентрацию и усидчивость при работе с ними.
                    </p>
                    <h3>
                        Применимость теории когнитивной нагрузки при составлении опросов
                        сотрудников
                    </h3>
                    <h4>Традиционный подход vs Happy Job</h4>
                    <div style="padding: 40px; color: black; outline: 6px solid #ffcccc">
                        <p>
                            Традиционные методы организации опроса сотрудников не учитывают
                            влияние когнитивной нагрузки на респондентов.
                        </p>
                        <p>
                            Как правило, такие опросники объёмные, состоят из однотипных задач и
                            на их прохождение требуется много времени.
                        </p>
                        <p>
                            Пользователи подобных методов сталкиваются с проблемами, которые не
                            всегда можно предусмотреть:
                            <br>
                        </p>
                        <ul>
                            <li>
                                • Однотипность утверждений и структуры приводят к
                                <b> формальным, поверхностным ответам. </b>
                            </li>
                            <li>
                                • Объёмные и традиционные вопросы утомляют. К концу опроса человек
                                становится невнимательным, хочет закончить как можно скорее,
                                <b> выбирает ответы наобум. </b>
                            </li>
                            <li>
                                • Из-за большого количества однотипных вопросов у респондентов
                                <b> вырабатывается установка на ответ </b>
                                .  Например, если на первые три вопроса выбрали вариант
                                «абсолютно согласен», то и на последующие ответят также.
                            </li>
                            <li>
                                • В опросах сотрудников часто используется шкала Ликерта — шкала со
                                значениями от «абсолютно несогласен» до «абсолютно согласен». Она
                                подвергается критике за наличие «предпочтительных» вариантов ответа.
                                Респонденты
                                <b> склонны давать социально-ожидаемые ответы </b>
                                вместо того, чтобы делиться реальными мыслями.
                            </li>
                            <li>
                                • В шкале Ликерта позитивный вариант ответа, как правило, стоит на
                                одном и том же месте. Респонденты
                                <b> выбирают его механически </b>
                                , не задумываясь о сути вопроса.
                            </li>
                            <li>
                                • Шкала Ликерта позволяет респондентам
                                <b> выбирать нейтральный ответ </b>
                                . Существует мнение, что наличие нейтральной точки в исследованиях —
                                пустая трата сил и времени исследователя. В лучшем случае полученная
                                в ходе опроса информация не будет иметь большой ценности, в худшем —
                                приведет к искажению результатов.
                            </li>
                            <li>
                                • Иногда шкала Ликерта приводит к другой крайности — респонденты
                                всегда
                                <b> выбирают абсолютные показатели при ответе </b>
                                . Это тоже сказывается на точности результата.
                            </li>
                            <li>
                                • Для построения и проверки надёжности тестов используется альфа
                                Кронбаха. В традиционных опросах этот индекс опускается ниже 0,5 при
                                норме от 0,7, что говорит о
                                <b> низкой достоверности исследования </b>
                                .
                            </li>
                            <li>
                                • В традиционных опросах
                                <b> сотрудники демонстрируют «видимую лояльность» </b>
                                , выбирая вариант ответа, который кажется более предпочтительным с
                                точки зрения работодателя.
                            </li>
                        </ul>
                    </div>
                    <p> </p>
                    <div style="outline: 6px solid #90ee90; padding: 40px; color: black">
                        <p>
                            Команда Happy Job модернизировала устаревшие способы проведения
                            опросов сотрудников. Для этого были пересмотрены продолжительность,
                            объём и подача опросов.
                        </p>
                        <p>В результате были определены стандарты исследований Happy Job:</p>
                        <ul>
                            <li>
                                •
                                <b> Точные и понятные формулировки. </b>
                                Мы избегаем объёмных вопросов и сложных терминов, смысл которых
                                непонятен с первого прочтения более 10% респондентов.
                            </li>
                            <li>
                                • Вопросы поддерживаются
                                <b>
                                    визуальными элементами на основе понятных с детства ментальных
                                    конструкций и моделей.
                                </b>
                                Это помогает добиться ясности формулировок вопросов для
                                максимального количества респондентов.
                            </li>
                            <li>
                                • Прохождение опроса занимает не больше 7 минут, а опросник включает
                                от 5 до 12 вопросов — это
                                <b>
                                    оптимальные продолжительность и объём для поддержания максимальной
                                    концентрации внимания респондентов.
                                </b>
                                Исследования Happy Job показали, что анкеты, на которые нужно
                                потратить больше времени, дают неточные результаты.
                            </li>
                            <li>
                                • Опросы Happy Job
                                <b> показывают высокую надёжность — 0,94 по альфе Кронбаха </b>
                                при общепринятом пороге в 0,7 (результат исследования по протоколу
                                №54С4 от 02.07.2016 года в составе 11 членов комиссии). Исследование
                                надёжности проводилось опытным путём, на выборке из 4 780
                                респондентов, случайным образом отобранных из нашей базы данных. В
                                выборку вошли представители разных отраслей и регионов.
                            </li>
                            <li>
                                •
                                <b> Приятный дизайн, вовлекающая анимация, эмодзи </b>
                                и другие элементы помогают добиться большего погружения респондентов
                                в процесс прохождения опроса.
                            </li>
                            <li>
                                • Когнитивная нагрузка уменьшается, если информация воспринимается
                                через разные каналы. Happy Job
                                <b> чередует разные форматы вопросов. </b>
                                Такой подход помогает мозгу справиться с поставленной задачей в
                                несколько секунд.
                            </li>
                            <li>
                                • В опросах Happy Job
                                <b> сотрудники максимально честно отвечают на вопросы. </b>
                                Результаты исследования, таким образом, точно отображают реальное
                                положение дел в компании.
                            </li>
                        </ul>
                    </div>
                    <h2 id="title2">Геймификация
                                    в опросах Happy Job</h2>
                    <p>
                        Привлекать внимание, удерживать интерес людей позволяют элементы игры.
                        Инструменты геймификации — популярное и эффективное средство для
                        максимального вовлечения в процесс.
                    </p>
                    <blockquote>
                        <p>
                            «Геймификация — это применение самых интересных и вовлекающих
                            элементов из игр в повседневной жизни, работе, бизнесе и т.д. Это
                            дизайн, ориентированный на человека (human-focused design) и
                            оптимизированный под его эмоциональное состояние (чувства, мотивацию,
                            вовлечённость)», — Юкай Чоу, один из ведущих специалистов по
                            геймификации в мире.
                        </p>
                    </blockquote>
                    <div class="row align-items-center videoWrapBlock">
                        <div class="col-lg-4 video-wrap">
                            <video width="275" class="embed-responsive" id="video-3" poster="/videos/survey_4_v2.jpeg" playsinline="" loop="" muted="" autoplay="" title="Геймификация в опросах сотрудников Happy Job" alt="">
                                <source src="/videos/survey_4_v2.mp4" type="video/mp4">
                                <source src="/videos/survey_4_v2.webm" type="video/webm">
                            </video>
                        </div>
                        <div class="col-lg-8" style="padding: 0 40px 40px 40px">
                            <p>
                                Геймификация использует мотивационные свойства игры и обращается к
                                потребности человека побеждать, делиться успехами, общаться. Смысл
                                этого заключается в том, чтобы привнести развлекательные элементы в
                                занятия, которые изначально не связаны с весельем. В отличие от
                                стандартных методов мотивации, геймификация создаёт контекст,
                                который сам по себе мотивирует людей к действию.
                            </p>
                            <p>
                                <strong>
                                    Геймификация в опросах сотрудников Happy Job — это применение
                                    игровых элементов для интенсивного вовлечения респондентов в
                                    опросы и получения в итоге достоверной информации.
                                </strong>
                            </p>
                        </div>
                    </div>
                    <h3>Примеры геймификации в опросах сотрудников:</h3>
                    <h4>Элемент «Прогресс-бар»</h4>
                    <br>
                    <img alt="Вовлечённость персонала в работу" src="/img/happy-job/images/metodika/science_01.jpg" title="В опросах Happy Job респонденты могут видеть прогресс заполнения благодаря прогресс-бару">
                    <br>
                    <br>
                    <p>
                        Прогресс-бар — это визуальный индикатор, который демонстрирует
                        участникам, как далеко они продвинулись в опросе.
                    </p>
                    <p>
                        <strong>
                            Люди с большей вероятностью заканчивают начатое дело, когда видят свой
                            прогресс.
                        </strong>
                        Благодаря прогресс-барам большее количество участников доходят до конца
                        опроса, и результат исследования становится более точным.
                    </p>
                    <h4>Элемент «Ползунок»</h4>
                    <br>
                    <img alt="Повысить вовлечённость сотрудников" src="/img/happy-job/images/metodika/science_02.jpg" title="Слайдер позволяет сотрудникам выбрать подходящий ответ в опросах Happy Job">
                    <br>
                    <br>
                    <p>
                        Ползунок — это слайдер, с помощью которого можно произвольно выбрать
                        интенсивность ответа
                    </p>
                    <p>
                        <strong>
                            Ползунки дают респондентам больше свободы в ответе на вопросы.
                        </strong>
                        В отличие от традиционной шкалы Ликерта они не имеют рисков негативных
                        сценариев с выбором нейтральных ответов или выбором ответов на автомате.
                    </p>
                    <h4>Элемент «Звёздный рейтинг»</h4>
                    <br>
                    <img alt="Прогресс-бар" src="/img/happy-job/images/metodika/science_03.jpg" title="Звёздный рейтинг позволяет сотрудникам выразить отношение к утверждению в опросах Happy Job">
                    <br>
                    <br>
                    <p>
                        Звёздный рейтинг — инструмент для выбора ответа в виде рейтинга из
                        звёзд. Он позволяет выразить отношение к определённому утверждению.
                    </p>
                    <p>
                        <strong>
                            Наглядность такой оценки позволяет получить справедливый и однозначный
                            результат.
                        </strong>
                    </p>
                    <h4>Результаты использования геймификации в опросах сотрудников</h4>
                    <p>
                        <strong>
                            Геймификация позволяет заинтересовать респондентов и укрепить статус
                            опросов как увлекательного занятия.
                        </strong>
                        Игровые элементы мотивируют людей, ведь повседневное действие становится
                        чем-то необычным, интересным. В то же время анимация и иллюстрации на
                        платформе выступают своеобразными «помощниками», которые дают
                        дополнительную информацию о механизме опроса.
                    </p>
                    <p>
                        Существует огромная разница в восприятии геймифицированных опросов
                        сотрудников и традиционных. Геймифицированные опросы Happy Job считают
                        интересными 87% респондентов, а вовлекающими — 97%. У традиционных
                        опросов результаты 9% и 11% соответственно. Исследование проводилось на
                        выборке из 264 000 сотрудников разных компаний.
                    </p>
                    <br>
                    <img alt="Критерии вовлечённости персонала" src="/img/happy-job/images/metodika/science_04.jpg" title="Геймифицированные опросы Happy Job считают интересными подавляющее большинство респондентов">
                    <br>
                    <br>
                    <br>
                    <img alt="Опрос вовлечённости сотрудников" src="/img/happy-job/images/metodika/science_05.jpg" title="Геймифицированные опросы Happy Job считают вовлекающими подавляющее большинство респондентов">
                    <br>
                    <br>
                    <h3>Когда имеет смысл применять геймификацию в опросах персонала</h3>
                    <p>
                        Инструменты геймификации позволяют сделать опрос сотрудников
                        увлекательным. В результате растёт процент участия, точность результатов
                        исследования. Добиться максимального эффекта от использования
                        геймификации можно в том случае, если правильно определены цели
                        исследования, его задачи. Перед началом опроса необходимо чётко
                        понимать, для чего всё это делается.
                    </p>
                    <h2 id="title3">Что можно узнать о сотрудниках после опросов Happy Job</h2>
                    <p>
                        Опросы сотрудников от Happy Job определят степень вовлечённости,
                        лояльности и удовлетворённости персонала. Наш авторский
                        <strong>
                            индикатор Happy Index покажет процент одновременно вовлечённых и
                            лояльных людей в компании.
                        </strong>
                        На сегодняшний день это один из самых точных методов исследования
                        вовлечённости, удовлетворённости и лояльности персонала.
                    </p>
                    <p>
                    ...
                    <p>
                        Наша методика исследует вовлечённость и лояльность сотрудников через 10
                        метрик вовлечённости и 5 метрик лояльности. На видео ниже
                        <a href="/aleksey-klochkov/"> Алексей Клочков </a>
                        , основатель Happy Job, объясняет, как происходит исследование
                  ...
                  <span class="videos-image-wrapper">
                    ...
                    <h2 id="title4">Опросы сотрудников на Happy Job дают точные результаты</h2>
                    <p>
                        <strong>
                            Валидность метода исследования — характеристика, которая оценивает его
                            качество.
                        </strong>
                        Изучение валидности требуется для ответа на важный вопрос — способна ли
                        методика дать правильную оценку предмету измерения
                    </p>
                    <p>
                        Методика изучения вовлечённости и лояльности Happy Job успешно прошла
                        проверки на концептуальную, содержательную, эмпирическую, текущую и
                        прогностическую валидности.
                    </p>
                    <p>
                        Проверка концептуальной и содержательной валидности нашего подхода была
                        проведена с помощью сопоставления результатов двух разных исследований
                        на одной и той же фокус-группе. В ходе проверки использовались два
                        метода: онлайн-опрос из 57 вопросов и опросное интервью фокус-группы
                        (исследования по протоколу №174С2 от 16.05.2016 года в присутствии 7
                        членов комиссии). Дополнительно была проведена проверка на 14-ти
                        фокус-группах, в которые вошли 278 человек разного пола, возраста,
                        статуса. В обоих случаях
                        <strong>
                            результаты доказали — респонденты понимают суть вопроса и дают ответы,
                            которые полностью соответствуют предмету изучения.
                        </strong>
                    </p>
                    <p>
                        Измерение эмпирической валидности проводилось по внешнему показателю —
                        через сопоставление процентного соотношения выполнения плана и
                        вовлечённости. Данная корреляция определяет валидность опроса для оценки
                        вовлечённости среды. Текущая валидность исследования измеряется с
                        помощью сравнения индивидуального результата по KPI с показателем
                        вовлечённости. Оба исследования показали высокую точность методики.
                    </p>
                    <p>
                        Также методика Happy Job успешно прошла проверку на прогностическую
                        валидность. Метрики вовлечённости и лояльности (желание остаться в
                        компании, признание заслуг и понимание карьерного роста)
                        <strong>
                            с 87%-ной точностью предсказали количество уволившихся сотрудников в
                            6-месячный период после проведения опроса.
                        </strong>
                    </p>
                    <h2 id="title5">Как научный подход
                                    реализован на платформе Happy Job</h2>
                    <p>
                        В платформе Happy Job реализован научный подход к опросам сотрудников.
                        Он включает в себя:
                    </p>
                    <ol>
                        <li>
                            <b> Удобство для респондентов. </b>
                            Опросы проходят онлайн и занимают 5-7 минут — даже самый загруженный
                            специалист может найти время на заполнение анкеты. Опросы доступны с
                            компьютеров, мобильных телефонов и планшетов. При необходимости
                            респондент может делать паузы и возвращаться к опросу позднее —
                            платформа сохранит прогресс прохождения.
                            <br>
                            У платформы Happy Job понятный интерфейс: для участия в опросе нужны
                            лишь базовые компьютерные навыки, дизайн и анимация делают навигацию
                            интуитивно понятной для всех пользователей.
                        </li>
                        <li>
                            <b> Вовлечение в опрос. </b>
                            Инструменты геймификации помогают вовлекать сотрудников и мотивируют
                            их отвечать на все вопросы. Итогом исследования становится полноценный
                            отчёт с исчерпывающей информацией о ситуации в компании и настроениях
                            персонала.
                        </li>
                        <li>
                            <b> Достоверность данных. </b>
                            Достоверность результатов опросов обусловлена тем, что формулировки
                            вопросов Happy Job исключают вариант с угадыванием «хороших» ответов.
                            Кроме того, респонденты заполняют анкеты анонимно и могут показать
                            свое истинное отношение к предмету вопроса. Таким образом, можно
                            выявить проблемные моменты и оперативно принять меры для их улучшения.
                        </li>
                        <li>
                            <b> Продвижение опроса среди сотрудников. </b>
                            Участие в опросе покажется бессмысленным занятием, если не убедить
                            коллектив в важности происходящего. Когда ваши сотрудники знают, что
                            их мнения могут повлиять на ситуацию в компании, они охотнее заполняют
                            анкеты. На платформе Happy Job доступны промо-материалы, которые
                            облегчат задачу по продвижению опросов среди персонала. Более того,
                            часть из них отправляется автоматически с платформы, что освобождает
                            время HR-специалиста, ответственного за проведение опросов.
                        </li>
                        <li>
                            <b> Руководство к действию. </b>
                            Отчёты, которые автоматически формируются после завершения опроса,
                            содержат рекомендации по улучшению показателей вовлечённости,
                            удовлетворённости и лояльности. Следуя этим инструкциям, можно
                            значительно улучшить атмосферу в коллективе и продуктивность компании.
                            <br>
                            Помимо рекомендаций на тему внедрения изменений можно читать рассылки
                            Happy Job, материалы в
                            <a href="https://happy-inc.ru/blog/" target="_blank"> Happy Blog </a>
                            и статьи экспертов Happy Job в авторитетных изданиях.
                        </li>
                        <li>
                            <b> Совместимость с данными других провайдеров. </b>
                            Платформа совместима с данными от других провайдеров, поэтому при
                            переходе на Happy Job можно сохранить результаты предыдущих опросов.
                            Подробнее об этом расскажут наши менеджеры.
                        </li>
                    </ol>
                    <br>
                    <section class="quote-banner wide-container">
                        <blockquote class="quote-banner-text animated fadeIn">
                            <p>
                                Чтобы клиенты полюбили компанию, <br>её должны полюбить
                                <strong class="font-rosa-marena">сотрудни</strong><span><svg><use href="#caveat-k"></use></svg></span><strong class="font-rosa-marena">и</strong>
                            </p>
                        </blockquote>
                    </section>
                    <h2 id="title6">О компании Happy Job в цифрах</h2>
                    <p>
                        Опыт участия в опросах Happy Job оценивают как положительный
                        <strong> 98,1% </strong>
                        респондентов. Исследование проводилось на выборке из 264 000 сотрудников
                        из разных компаний и отраслей.
                    </p>
                    <p>
                        <strong> 94% </strong>
                        руководителей отметили удобство работы с результатами опросов,
                        понятность метрик и показателей и полезность рекомендаций.
                    </p>
                    <p>
                        В опросах Happy Job всегда участвует не менее
                        <strong> 70% </strong>
                        сотрудников. Эта цифра растёт, когда опросы становятся привычной частью
                        корпоративной культуры.
                    </p>
                    <p>
                        Общее число участников опросов Happy Job на сегодняшний день превысило
                        <strong> 3 500 000 </strong>
                        человек.
                    </p>
                    <p>
                        С 2016 года по сегодняшний день с помощью платформы Happy Job проводили
                        исследования вовлечённости и лояльности сотрудников свыше
                        <strong> 800 </strong>
                        компаний.
                    </p>
                    <br>
